...
export default function App() {
  ...
  const t = {
    fr: {
      ...
      debunk_cards: [
        { myth: "L'explosion migratoire africaine.", real: "Stabilité historique de la proportion (~1,9%).", stat_text: "1.9%", stat_val: 1.9, color: "bg-emerald-500", desc: "La part des migrants internationaux africains évolue très lentement. L'augmentation des volumes absolus n'est qu'un reflet de la croissance démographique continentale." },
        { myth: "L'Afrique envahit l'Europe.", real: "Les migrations intra-africaines dominent (70%).", stat_text: "70%", stat_val: 70, color: "bg-teal-500", desc: "Les pôles d'attraction sont internes. Des pays comme la Côte d'Ivoire ou l'Afrique du Sud attirent massivement les travailleurs régionaux." },
        { myth: "Le Nord accueille la majorité des réfugiés.", real: "Les réfugiés restent dans les pays frontaliers.", stat_text: "76%", stat_val: 76, color: "bg-orange-500", desc: "Le rapport HCR 2025 confirme que l'écrasante majorité des personnes fuyant les conflits trouvent refuge dans des pays limitrophes du Sud." },
        { myth: "La migration est une affaire d'hommes.", real: "Féminisation structurelle des flux (47%).", stat_text: "47%", stat_val: 47, color: "bg-purple-500", desc: "Les femmes représentent aujourd'hui près de la moitié des migrants, redéfinissant l'économie du soin." },
        { myth: "L'Afrique dépend de l'Aide Internationale.", real: "Les transferts de la diaspora dépassent l'aide publique.", stat_text: "3x plus", stat_val: 75, color: "bg-amber-500", desc: "Les envois de fonds constituent un filet de sécurité vital qui surpasse largement les budgets de l'aide internationale." },
        ...
        { myth: "Les pays d'Afrique côtière ne sont que des zones de passage.", real: "Transformation structurelle en pays de destination.", stat_text: "Mutation", stat_val: 65, color: "bg-indigo-500", desc: "Contrairement au narratif de l'Europe 'forteresse', les États perçus comme de simples espaces de passage voient une majorité de personnes s'y installer durablement, transformant leur gouvernance locale et leur tissu socio-économique." },
        { myth: "Le développement économique arrêtera les départs.", real: "Le paradoxe de la transition (Migration Hump).", stat_text: "Catalyseur", stat_val: 80, color: "bg-cyan-500", desc: "Historiquement et statistiquement, l'augmentation initiale des revenus dans un pays en développement fournit en réalité le capital nécessaire pour migrer. La mobilité augmente avec le développement avant de se stabiliser." },
        { myth: "Les migrants représentent un fardeau pour les pays d'accueil du Sud.", real: "Ils sont des moteurs de l'économie informelle et de l'emploi.", stat_text: "+ Valeur", stat_val: 85, color: "bg-rose-500", desc: "Les données montrent que les migrants intra-africains comblent des pénuries structurelles, stimulent la consommation locale et créent des micro-entreprises, contribuant positivement à la résilience des pays hôtes." }
      ],
      about: { 
        ...
        p2: "Rigueur empirique & Neutralité : Face à la polarisation des discours, ce projet s'inscrit dans une démarche strictement factuelle axée sur les réalités du continent africain.",
        ...
        expanded_p2: "Ce portail met en valeur les angles morts statistiques et s'impose comme un outil de référence factuel et apolitique pour les chercheurs, décideurs et la société civile.",
      ...
      hero_title: "Rétablir la vérité", hero_highlight: "par l'appropriation des données."
    },
    en: {
      ...
      modal: { 
        close: "Close", tabs: { demo: "Demography", geo: "Geography", econ: "Economy & AU Treaties" }, 
        south_view: "Analytical Perspective", evo_title: "The Proportional Constant (1990-2024)", parity: "Feminization of flows", retention_title: "Regional Retention (South-South)", orig_dest_title: "Transition & Proximity Dynamics", econ_title: "Economic Independence & AU Ratifications", 
      ...
      debunk_cards: [
        { myth: "The African migration explosion.", real: "Historical stability of proportion (~1.9%).", stat_text: "1.9%", stat_val: 1.9, color: "bg-emerald-500", desc: "The share of international migrants evolves very slowly. Absolute volume increase is a reflection of demographic growth." },
        { myth: "Africa is invading Europe.", real: "Intra-African migrations dominate (70%).", stat_text: "70%", stat_val: 70, color: "bg-teal-500", desc: "Poles of attraction are internal. Countries like Côte d'Ivoire or South Africa massively attract regional workers." },
        { myth: "The North hosts the majority of refugees.", real: "Refugees stay in bordering countries.", stat_text: "76%", stat_val: 76, color: "bg-orange-500", desc: "The UNHCR 2025 report confirms the overwhelming majority of people fleeing conflicts find refuge in neighboring Southern countries." },
        { myth: "Migration is primarily a male affair.", real: "Structural feminization of flows (47%).", stat_text: "47%", stat_val: 47, color: "bg-purple-500", desc: "Women now represent nearly half of migrants, redefining the global care economy." },
        { myth: "Africa depends on International Aid.", real: "Remittances far exceed official public aid.", stat_text: "3x more", stat_val: 75, color: "bg-amber-500", desc: "Diaspora remittances constitute a vital safety net that far surpasses international aid budgets." },
        ...
        { myth: "Coastal African nations are merely areas of passage.", real: "Structural transformation into destination countries.", stat_text: "Mutation", stat_val: 65, color: "bg-indigo-500", desc: "Contrary to the 'Fortress Europe' narrative, states perceived as simple areas of passage see a majority of people settle permanently, transforming local governance and socioeconomic fabrics." },
      ...
      method: { 
        ...
        s5: "International Labour Organization (ILO NORMLEX) & African Union Treaties"
      },
      myth: "Mythe", reality: "Réalité",
      ...
      hero_title: "Reclaiming truth", hero_highlight: "through data ownership."
    }
  };
  ...
  const countryData = {
    "af_med": [
      ...
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 2, "technical": 19, "total": 29},
      ...
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 4, "technical": 53, "total": 65},
      ...
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 9, "governance": 3, "technical": 53, "total": 65},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      }
    ],
    "af_west": [
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 2, "technical": 22, "total": 32},
      ...
      { 
        ...
        "normlex": {"fundamental": 9, "governance": 4, "technical": 31, "total": 44},
      ...
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 9, "governance": 2, "technical": 5, "total": 16},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 11, "governance": 4, "technical": 33, "total": 48},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 0, "technical": 11, "total": 19},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 2, "technical": 42, "total": 52},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 9, "governance": 3, "technical": 50, "total": 62},
      ...
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 1, "technical": 25, "total": 34},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 8, "governance": 2, "technical": 17, "total": 27},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": false },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 10, "governance": 3, "technical": 23, "total": 36},
      ...
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 9, "governance": 3, "technical": 34, "total": 46},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
      ...
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 10, "governance": 3, "technical": 31, "total": 44},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 11, "governance": 2, "technical": 33, "total": 46},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 9, "governance": 4, "technical": 15, "total": 28},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      }
    ],
    "af_central": [
      { 
        ...
        "normlex": {"fundamental": 10, "governance": 3, "technical": 30, "total": 43},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 9, "governance": 3, "technical": 39, "total": 51},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 9, "governance": 3, "technical": 35, "total": 47},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 3, "technical": 17, "total": 28},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 9, "governance": 3, "technical": 23, "total": 35},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 8, "governance": 2, "technical": 27, "total": 37},
      ...
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 8, "governance": 0, "technical": 6, "total": 14},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 9, "governance": 3, "technical": 30, "total": 42},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 10, "governance": 2, "technical": 13, "total": 25},
    ...
    "af_east": [
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 2, "technical": 21, "total": 31},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 9, "governance": 3, "technical": 26, "total": 38},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 9, "governance": 3, "technical": 58, "total": 70},
      ...
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 8, "governance": 0, "technical": 0, "total": 8},
      ...
      { 
        ...
        "normlex": {"fundamental": 9, "governance": 1, "technical": 13, "total": 23},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 7, "governance": 3, "technical": 42, "total": 52},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 11, "governance": 4, "technical": 38, "total": 53},
        "au_treaties": { "constitutive": true, "abuja": false, "refugees_1969": false, "kampala": false, "free_movement": false, "zlecaf": false },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 11, "governance": 3, "technical": 19, "total": 33},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 10, "governance": 2, "technical": 40, "total": 52},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": false, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 11, "governance": 3, "technical": 12, "total": 26},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 10, "governance": 3, "technical": 22, "total": 35},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": true, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 9, "governance": 2, "technical": 27, "total": 38},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 1, "technical": 17, "total": 26},
      ...
      { 
        ...
        "normlex": {"fundamental": 7, "governance": 0, "technical": 0, "total": 7},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": false },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 9, "governance": 3, "technical": 7, "total": 19},
      ...
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 1, "technical": 28, "total": 37},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 3, "technical": 21, "total": 32},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 10, "governance": 4, "technical": 35, "total": 49},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 10, "governance": 3, "technical": 14, "total": 27},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      }
    ],
    "af_south": [
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 3, "technical": 6, "total": 17},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "normlex": {"fundamental": 8, "governance": 2, "technical": 23, "total": 33},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
        ...
        "idp_conflict": 0, "idp_disaster": 0, "refugees_hosted": 0, "avoi": 50, 
        "normlex": {"fundamental": 11, "governance": 2, "technical": 14, "total": 27},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": true, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      },
      { 
      ...
      { 
        ...
        "normlex": {"fundamental": 9, "governance": 2, "technical": 17, "total": 28},
        "au_treaties": { "constitutive": true, "abuja": true, "refugees_1969": true, "kampala": false, "free_movement": false, "zlecaf": true },
        ...genericDesc 
      }
    ]
  ...
  const aggregates = {
    'africa_perspective': { 
      ...
      distribution: [{ label: {fr: 'Intra-Africain', en: 'Intra-African'}, value: 70, color: 'bg-emerald-500' }, { label: {fr: 'Extra-Africain', en: 'Extra-African'}, value: 30, color: 'bg-teal-700' }],
      ...genericDesc
    }
  };
  ...
  const indicatorThemes = [
    {
      theme_fr: "Intégration & Libre Circulation", theme_en: "Integration & Free Movement", icon: <GitMerge />, color: "text-indigo-500",
      items: [
        { 
    ...
    {
      theme_fr: "Économie Productive & Diasporas", theme_en: "Productive Economy & Diasporas", icon: <TrendingUp />, color: "text-amber-500",
      items: [
        { 
    ...
    {
      theme_fr: "Mobilité Climatique & Adaptation", theme_en: "Climate Mobility & Adaptation", icon: <Leaf />, color: "text-emerald-500",
      items: [
        { 
    ...
    {
      theme_fr: "Santé & Économie du Soin (Care)", theme_en: "Health & Care Economy", icon: <HeartPulse />, color: "text-rose-500",
      items: [
        { 
    ...
    {
      theme_fr: "Savoirs & Circulation des Compétences", theme_en: "Knowledge & Skills Circulation", icon: <BookOpen />, color: "text-blue-500",
      items: [
        { 
    ...
    {
      theme_fr: "Protection & Justice Sociale", theme_en: "Protection & Social Justice", icon: <Scale />, color: "text-purple-500",
      items: [
        { 
  ...
  return (
    <div className={`min-h-screen bg-slate-50 font-sans text-slate-800 text-sm transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'} print:bg-white print:text-black`}>
      ...
      {/* NAVBAR */}
      <nav className="bg-slate-900/95 backdrop-blur-md text-white sticky top-0 z-50 border-b border-slate-800 shadow-xl print:hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between h-14 items-center">
          <div className="flex items-center space-x-3">
            <div className="bg-gradient-to-br from-emerald-400 to-emerald-600 p-1.5 rounded-lg shadow-lg shadow-emerald-500/20"><Globe className="h-4 w-4 text-slate-900" /></div>
            <span className="text-base font-black tracking-tight uppercase">{text.title} <span className="text-emerald-400 font-medium lowercase italic">{text.subtitle}</span></span>
          </div>
          <button onClick={() => setLang(lang === 'fr' ? 'en' : 'fr')} className="flex items-center space-x-1 text-[10px] font-bold bg-slate-800 px-3 py-1.5 rounded-full border border-slate-700 transition hover:bg-slate-700 hover:text-emerald-400">
      ...
      {/* HERO HEADER */}
      <header className="bg-slate-900 text-white py-12 relative overflow-hidden print:hidden border-b border-emerald-900/30">
        ...
        <div className="absolute top-0 right-0 -mr-20 -mt-20 opacity-[0.03] pointer-events-none"><Globe className="w-[400px] h-[400px]" /></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="inline-block px-3 py-1 rounded-full bg-slate-800 border border-slate-700 text-[10px] font-bold text-emerald-400 mb-4 uppercase tracking-widest shadow-sm">Open Data Initiative</div>
          <h1 className="text-3xl md:text-5xl font-black mb-4 leading-[1.1] tracking-tight">{text.hero_title}<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-200 italic font-medium">{text.hero_highlight}</span></h1>
          <p className="text-slate-400 max-w-2xl text-base leading-relaxed font-medium">{text.desc}</p>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 print:hidden space-y-16">
        ...
        {/* 1. DÉCONSTRUCTION */}
        <section>
          <div className="flex items-center space-x-3 mb-6"><div className="p-2 bg-rose-100 rounded-lg text-rose-600"><ShieldAlert className="h-5 w-5" /></div><h2 className="text-xl font-black text-slate-900 tracking-tight">{text.sections.debunk}</h2></div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {text.debunk_cards.map((card, idx) => (
              <div 
                key={idx} 
                onClick={() => setExpandedMyth(expandedMyth === idx ? null : idx)}
                className={`bg-white rounded-2xl p-5 border transition-all duration-300 flex flex-col cursor-pointer ${expandedMyth === idx ? 'border-emerald-400 shadow-xl scale-[1.02]' : 'border-slate-200 shadow-sm hover:shadow-md hover:border-emerald-200'}`}
              >
                <div>
                  <div className="flex justify-between items-center mb-3">
                    <span className="text-[9px] font-black uppercase text-rose-500 tracking-widest bg-rose-50 px-2 py-0.5 rounded-md">{text.myth}</span>
                    <ChevronDown className={`w-3.5 h-3.5 text-slate-400 transition-transform duration-300 ${expandedMyth === idx ? 'rotate-180 text-emerald-500' : ''}`} />
                  </div>
                  <p className="text-slate-800 font-serif italic text-sm md:text-base leading-snug mb-3">"{card.myth}"</p>
                </div>
                <div className="pt-4 border-t border-slate-100 mt-auto">
                  <span className="text-[9px] font-black uppercase text-emerald-600 tracking-widest bg-emerald-50 px-2 py-0.5 rounded-md">{text.reality}</span>
                  <p className="text-slate-900 font-black text-base mt-2 mb-2 leading-tight">{card.real}</p>
                  <div className="flex items-center space-x-3">
                     <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                       <div className={`${card.color} h-full transition-all duration-1000 ease-out`} style={{width: `${card.stat_val}%`}}></div>
                     </div>
                     <span className={`text-xs font-black ${card.color.replace('bg-', 'text-')}`}>{card.stat_text}</span>
                  </div>
                </div>
        ...
        <section className="bg-slate-900 rounded-3xl p-8 md:p-10 text-white shadow-2xl border border-slate-800 relative overflow-hidden print:bg-white print:border-2 print:text-slate-900 print:shadow-none">
          ...
          <div className="relative z-10 flex items-center space-x-3 mb-8">
            <div className="p-2 bg-emerald-500/20 rounded-lg text-emerald-400 print:bg-slate-100 print:text-emerald-600"><Globe className="h-5 w-5" /></div>
            <h2 className="text-xl md:text-2xl font-black tracking-tight">{text.sections.global}</h2>
          </div>
          
          <div className="relative z-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
            <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50 print:bg-slate-50 print:border-slate-200">
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">{text.global_stats.world}</span>
              <span className="text-2xl font-black text-white print:text-slate-900 block">304 M</span>
              <div className="w-full bg-slate-700 h-1 mt-2 rounded-full overflow-hidden print:bg-slate-200"><div className="bg-slate-500 h-full w-full"></div></div>
            </div>
            <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50 print:bg-slate-50 print:border-slate-200">
              <span className="text-[10px] font-black text-blue-400 uppercase tracking-widest block mb-1">{text.global_stats.europe}</span>
              <span className="text-2xl font-black text-white print:text-slate-900 block">94 M</span>
              <div className="flex justify-between items-center mt-2"><div className="w-full bg-slate-700 h-1 rounded-full overflow-hidden mr-2 print:bg-slate-200"><div className="bg-blue-500 h-full" style={{width: '30.9%'}}></div></div><span className="text-[9px] font-bold text-slate-400">30.9%</span></div>
            </div>
            <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50 print:bg-slate-50 print:border-slate-200">
              <span className="text-[10px] font-black text-rose-400 uppercase tracking-widest block mb-1">{text.global_stats.asia}</span>
              <span className="text-2xl font-black text-white print:text-slate-900 block">92 M</span>
              <div className="flex justify-between items-center mt-2"><div className="w-full bg-slate-700 h-1 rounded-full overflow-hidden mr-2 print:bg-slate-200"><div className="bg-rose-500 h-full" style={{width: '30.2%'}}></div></div><span className="text-[9px] font-bold text-slate-400">30.2%</span></div>
            </div>
            <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50 print:bg-slate-50 print:border-slate-200">
              <span className="text-[10px] font-black text-purple-400 uppercase tracking-widest block mb-1">{text.global_stats.na}</span>
              <span className="text-2xl font-black text-white print:text-slate-900 block">61 M</span>
              <div className="flex justify-between items-center mt-2"><div className="w-full bg-slate-700 h-1 rounded-full overflow-hidden mr-2 print:bg-slate-200"><div className="bg-purple-500 h-full" style={{width: '20%'}}></div></div><span className="text-[9px] font-bold text-slate-400">20.1%</span></div>
            </div>
            <div className="bg-emerald-500/10 p-4 rounded-xl border border-emerald-500/30 transform hover:scale-105 transition-transform print:bg-emerald-50 print:border-emerald-200 shadow-[0_0_15px_rgba(16,185,129,0.15)]">
              <span className="text-[10px] font-black text-emerald-400 uppercase tracking-widest block mb-1 print:text-emerald-600">{text.global_stats.africa}</span>
              <span className="text-2xl font-black text-emerald-300 print:text-emerald-700 block">29 M</span>
              <div className="flex justify-between items-center mt-2"><div className="w-full bg-slate-700 h-1 rounded-full overflow-hidden mr-2 print:bg-emerald-200"><div className="bg-emerald-400 h-full" style={{width: '9.5%'}}></div></div><span className="text-[9px] font-black text-emerald-400 print:text-emerald-700">9.5%</span></div>
            </div>
            <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50 print:bg-slate-50 print:border-slate-200">
              <span className="text-[10px] font-black text-amber-400 uppercase tracking-widest block mb-1">{text.global_stats.latam}</span>
              <span className="text-2xl font-black text-white print:text-slate-900 block">17 M</span>
...
<div className="mt-8 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex flex-col items-center">
  ...
  <img 
    ...
    className="max-w-md w-full h-auto rounded-xl shadow-lg border border-slate-100" 
  />
  <p className="text-[10px] text-slate-400 mt-4 italic">
    {lang === 'fr' ? "Représentation cartographique à titre illustratif." : "Cartographic representation for illustrative purposes."}
        ...
        <section id="explorer">
          <div className="flex items-center space-x-3 mb-6"><div className="p-2 bg-emerald-100 rounded-lg text-emerald-600"><MapPin className="h-5 w-5" /></div><h2 className="text-xl font-black text-slate-900 tracking-tight">{text.sections.explorer}</h2></div>
          <div className="bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[500px] ring-1 ring-slate-900/5">
            <div className="w-full md:w-72 bg-slate-900 text-white flex flex-col border-r border-slate-800 shrink-0">
              <div className="p-5 border-b border-slate-800 bg-slate-800/50">
                <h4 className="text-emerald-400 text-[9px] font-black uppercase tracking-widest mb-2 flex items-center"><MapIcon className="w-3 h-3 mr-1.5" /> {text.sidebar.subregion}</h4>
                <select value={activeSubRegion} onChange={(e) => { setActiveSubRegion(e.target.value); setActiveSubTab('perspective'); }} className="w-full bg-slate-900 border border-slate-700 rounded-lg py-2 px-3 text-xs font-bold text-slate-200 focus:ring-2 focus:ring-emerald-500 outline-none cursor-pointer appearance-none shadow-inner">
              ...
              <div className="p-5 pb-2">
                <div className="relative"><input type="text" placeholder={text.sidebar.search} value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full bg-slate-800 border border-slate-700 rounded-lg py-2 pl-8 pr-3 text-xs focus:ring-2 focus:ring-emerald-500 outline-none transition-shadow" /><Search className="w-3.5 h-3.5 absolute left-3 top-2.5 text-slate-400" /></div>
              </div>
              <div className="flex-1 overflow-y-auto p-3 space-y-1.5 custom-scrollbar max-h-[400px]">
                <button onClick={() => setActiveSubTab('perspective')} className={`w-full flex items-center p-3 rounded-xl transition-all font-bold text-xs text-left mb-3 ${activeSubTab === 'perspective' ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-lg' : 'bg-slate-800/50 text-slate-300 hover:bg-slate-800'}`}><Database className="w-4 h-4 mr-2.5 shrink-0 opacity-80" /><span className="truncate">{activeSubRegion === 'all' ? text.perspectives.continent : text.perspectives.subregion}</span></button>
                {filteredCountries.map((item) => (
                  <button key={item.id} onClick={() => setActiveSubTab(item.id)} className={`w-full flex items-center p-2.5 rounded-xl transition-all font-bold text-xs text-left group ${activeSubTab === item.id ? 'bg-white text-slate-900 shadow-md' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}><span className="text-xl mr-2.5 shrink-0 drop-shadow-sm flag-emoji">{item.flag}</span><span className="truncate">{item.name?.[lang] || item.name?.fr || "Unknown"}</span>{activeSubTab === item.id && <ChevronRight className="w-3.5 h-3.5 ml-auto text-emerald-500" />}</button>
                ))}
              </div>
            </div>
            
            <div className="flex-1 p-6 md:p-10 animate-in fade-in zoom-in-95 duration-500 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-50 via-white to-white">
              <div className="flex items-center space-x-5 mb-10"><span className="text-6xl md:text-7xl drop-shadow-xl shrink-0 filter hover:scale-105 transition-transform flag-emoji">{display.flag}</span><div><h3 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight tracking-tighter">{display.name}</h3><div className="mt-2"><span className="px-3 py-1 bg-slate-100 text-slate-600 text-[9px] font-black uppercase rounded-full tracking-widest border border-slate-200 shadow-sm">{display.isRegion ? text.badge.regional : text.badge.country}</span></div></div></div>
              
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div className="bg-white p-6 rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] border border-slate-100 hover:-translate-y-1 transition-transform group"><div className="flex items-center space-x-1.5 text-blue-500 mb-4 font-black text-[9px] uppercase tracking-widest"><Users className="h-4 w-4" /> {text.metrics.stock}</div><span className="block text-3xl md:text-4xl font-black text-slate-800 tracking-tighter">{formatNumber(display.stock)}</span></div>
                <div className="bg-white p-6 rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] border border-slate-100 hover:-translate-y-1 transition-transform group"><div className="flex items-center space-x-1.5 text-purple-500 mb-4 font-black text-[9px] uppercase tracking-widest"><HeartPulse className="h-4 w-4" /> {text.metrics.female}</div><span className="block text-3xl md:text-4xl font-black text-slate-800 tracking-tighter">{display.female}%</span></div>
                <div className="bg-white p-6 rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] border border-slate-100 hover:-translate-y-1 transition-transform group"><div className="flex items-center space-x-1.5 text-emerald-600 mb-4 font-black text-[9px] uppercase tracking-widest"><BarChart3 className="h-4 w-4" /> {text.metrics.evolution}</div><span className="block text-2xl md:text-3xl font-black text-slate-800 tracking-tighter">{display.evolution}%</span></div>
              </div>

              {/* VUE COMPARATIVE SPÉCIFIQUE SI PERSPECTIVE RÉGIONALE/CONTINENTALE */}
              {display.isRegion && (
                <div className="mt-8 p-6 bg-emerald-50/70 rounded-2xl border border-emerald-100 shadow-sm space-y-3">
                  <h4 className="text-emerald-900 font-black text-base flex items-center">
              ...
              <div className="mt-10 p-6 bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl text-white relative overflow-hidden shadow-xl group cursor-pointer" onClick={() => setShowModal(true)}>
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-5">
                  <div className="flex items-center space-x-4"><div className="p-3 bg-emerald-500/20 rounded-xl border border-emerald-500/30 group-hover:scale-110 transition-transform">{display.isRegion ? <PieChart className="w-6 h-6 text-emerald-400" /> : <TableProperties className="w-6 h-6 text-emerald-400" />}</div><div><h4 className="font-black text-lg mb-0.5">{display.isRegion ? text.modal.infographic_title : text.modal.raw_data_title}</h4><p className="text-slate-400 text-xs font-medium">{lang === 'fr' ? `Consulter l'analyse pour : ${display.name}.` : `View analysis for: ${display.name}.`}</p></div></div>
                  <button className="bg-emerald-500 text-slate-900 font-black px-6 py-3 rounded-xl text-xs transition-all flex items-center shrink-0 shadow-lg shadow-emerald-500/30 group-hover:bg-emerald-400">{text.analysis_btn}<ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-2 transition-transform" /></button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-10 border border-slate-200 shadow-sm">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-5 pb-6 border-b border-slate-100">
              <div className="flex items-center space-x-4">
                <div className="p-3 bg-slate-900 rounded-xl shadow-md"><BookOpen className="h-6 w-6 text-emerald-400" /></div>
                <div>
                  <h2 className="text-xl md:text-2xl font-black text-slate-900 tracking-tight">{text.sections.data}</h2>
                  <p className="text-slate-500 text-xs font-medium mt-2 leading-relaxed max-w-3xl">{text.indicator_desc}</p>
                </div>
              </div>
              <button onClick={exportIndicatorsCSV} className="flex items-center space-x-2 bg-white text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 hover:border-emerald-200 px-5 py-2.5 rounded-lg font-bold text-xs transition-all border border-slate-200 shadow-sm shrink-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
              {indicatorThemes.map((theme, i) => (
                <div key={i}>
                  <h3 className={`flex items-center text-base font-black ${theme.color} mb-5`}>
                  ...
                  <div className="space-y-3">
                    {theme.items.map((ind, j) => (
                      <div 
                        ...
                        className={`p-4 border rounded-xl transition-all cursor-pointer group flex flex-col items-start relative overflow-hidden ${expandedIndicator === ind.id ? 'bg-white border-emerald-400 shadow-lg' : 'bg-slate-50 border-slate-100 hover:border-emerald-300 hover:bg-emerald-50/50'}`}
                      >
                        <div className="flex items-center justify-between w-full mb-2 relative z-10">
                          <span className="text-[9px] font-black text-emerald-700 bg-emerald-100/80 px-2 py-0.5 rounded tracking-tighter shrink-0">
                            Ind. {ind.id}
                          </span>
                          <ChevronDown className={`w-4 h-4 text-slate-400 transition-transform duration-300 ${expandedIndicator === ind.id ? 'rotate-180 text-emerald-600' : 'group-hover:text-emerald-500'}`} />
                        </div>
                        ...
                        {(lang === 'fr' ? ind.desc_fr : ind.desc_en) && (
                          <p className="text-xs text-slate-500 mt-1.5 font-medium leading-relaxed relative z-10">
                            {lang === 'fr' ? ind.desc_fr : ind.desc_en}
                          </p>
                        )}
                        
                        {/* Zone extensible */}
                        <div className={`w-full overflow-hidden transition-all duration-500 relative z-10 ${expandedIndicator === ind.id ? 'max-h-96 opacity-100 mt-4 pt-4 border-t border-slate-100' : 'max-h-0 opacity-0'}`}>
                          <div className="space-y-4">
                            <div>
                              <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 block mb-1">{lang === 'fr' ? "🔍 Méthodologie & Collecte" : "🔍 Methodology & Data Collection"}</span>
                              <p className="text-xs text-slate-700 font-medium leading-relaxed">{lang === 'fr' ? ind.method_fr : ind.method_en}</p>
                            </div>
                            <div className="bg-emerald-50 p-3 rounded-lg border border-emerald-100">
                              <span className="text-[9px] font-black uppercase tracking-widest text-emerald-600 block mb-1">{lang === 'fr' ? "💡 Le Changement de Paradigme" : "💡 The Paradigm Shift"}</span>
                              <p className="text-xs text-emerald-800 font-medium leading-relaxed">{lang === 'fr' ? ind.contrast_fr : ind.contrast_en}</p>
                            </div>
                          </div>
                        </div>
        ...
        <section className="bg-white rounded-3xl p-8 md:p-10 border border-slate-200 shadow-sm">
          <div className="flex items-center space-x-4 mb-6">
            <div className="p-3 bg-emerald-100 rounded-xl text-emerald-600"><Target className="h-6 w-6" /></div>
            <div>
              <h2 className="text-xl md:text-2xl font-black text-slate-900 tracking-tight">{text.sdg_section.title}</h2>
              <p className="text-slate-500 text-xs font-medium mt-1">{text.sdg_section.subtitle}</p>
            </div>
          </div>

          <div className="flex bg-slate-100 p-1 rounded-xl mb-6 max-w-xl flex-wrap">
            <button onClick={() => setActiveSdgzTab('sdgs')} className={`flex-1 min-w-[120px] py-2 px-3 rounded-lg font-bold text-xs transition-all ${activeSdgzTab === 'sdgs' ? 'bg-white text-emerald-600 shadow-sm' : 'text-slate-500 hover:text-slate-800'}`}>
              ODD / SDGs
            </button>
            <button onClick={() => setActiveSdgzTab('gcm')} className={`flex-1 min-w-[120px] py-2 px-3 rounded-lg font-bold text-xs transition-all ${activeSdgzTab === 'gcm' ? 'bg-white text-emerald-600 shadow-sm' : 'text-slate-500 hover:text-slate-800'}`}>
              Pacte GCM (23 Obj.)
            </button>
            <button onClick={() => setActiveSdgzTab('gcr')} className={`flex-1 min-w-[120px] py-2 px-3 rounded-lg font-bold text-xs transition-all ${activeSdgzTab === 'gcr' ? 'bg-white text-emerald-600 shadow-sm' : 'text-slate-500 hover:text-slate-800'}`}>
              Pacte Réfugiés GCR
            </button>
          </div>
          ...
          {activeSdgzTab === 'sdgs' && (
            <div className="space-y-6 animate-in fade-in duration-300">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-emerald-50/60 p-4 rounded-xl border border-emerald-100">
                <p className="text-slate-700 text-xs md:text-sm font-medium leading-relaxed">
                  {text.sdg_section.sdg_desc}
                </p>
                <a href="https://www.un.org/sustainabledevelopment/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center space-x-1.5 bg-emerald-600 text-white px-4 py-2 rounded-lg text-xs font-bold hover:bg-emerald-700 transition shrink-0 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {text.sdg_section.sdg_points.map((pt, idx) => (
                  <div key={idx} className="p-5 bg-slate-50 rounded-2xl border border-slate-100 hover:border-emerald-300 transition-all">
                    <span className="text-[10px] font-black text-emerald-600 uppercase tracking-widest block mb-1">Cible ONU</span>
                    <h4 className="font-black text-slate-900 text-sm mb-2">{pt.title}</h4>
                    <p className="text-xs text-slate-600 font-medium leading-relaxed">{pt.desc}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          {activeSdgzTab === 'gcm' && (
            <div className="space-y-6 animate-in fade-in duration-300">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-indigo-50/60 p-4 rounded-xl border border-indigo-100">
                <p className="text-slate-700 text-xs md:text-sm font-medium leading-relaxed">
                  {text.sdg_section.gcm_desc}
                </p>
                <a href="https://www.iom.int/global-compact-migration" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center space-x-1.5 bg-indigo-600 text-white px-4 py-2 rounded-lg text-xs font-bold hover:bg-indigo-700 transition shrink-0 shadow-sm">
                  <span>{text.sdg_section.link_text}</span>
                  <ExternalLink className="w-3.5 h-3.5" />
                </a>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-h-[450px] overflow-y-auto pr-2 custom-scrollbar">
                {text.sdg_section.gcm_objectives_list.map((obj, idx) => (
                  <div key={idx} className="p-4 bg-slate-50 rounded-xl border border-slate-100 hover:border-indigo-300 transition-all">
                    <span className="text-[9px] font-black text-indigo-600 uppercase tracking-widest block mb-0.5">{obj.num}</span>
                    <h4 className="font-black text-slate-900 text-xs mb-1.5">{obj.title}</h4>
                    <p className="text-[11px] text-slate-600 font-medium leading-relaxed">{obj.desc}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          {activeSdgzTab === 'gcr' && (
            <div className="space-y-6 animate-in fade-in duration-300">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-amber-50/60 p-4 rounded-xl border border-amber-100">
                <p className="text-slate-700 text-xs md:text-sm font-medium leading-relaxed">
                  {text.sdg_section.gcr_desc}
                </p>
                <a href="https://globalcompactrefugees.org/about-digital-platform/global-compact-refugees" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center space-x-1.5 bg-amber-600 text-white px-4 py-2 rounded-lg text-xs font-bold hover:bg-amber-700 transition shrink-0 shadow-sm">
                  <span>{text.sdg_section.link_text}</span>
                  <ExternalLink className="w-3.5 h-3.5" />
                </a>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {text.sdg_section.gcr_objectifs.map((obj, idx) => (
                  <div key={idx} className="p-5 bg-slate-50 rounded-2xl border border-slate-100 hover:border-amber-300 transition-all">
                    <h4 className="font-black text-amber-800 text-sm mb-2">{obj.title}</h4>
                    <p className="text-xs text-slate-600 font-medium leading-relaxed">{obj.desc}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 print:hidden">
          <div className="bg-slate-900 rounded-3xl p-8 md:p-10 text-white shadow-xl relative overflow-hidden flex flex-col justify-between border border-slate-800">
            <div className="absolute top-0 right-0 -mr-10 -mt-10 opacity-10"><Info className="w-40 h-40" /></div>
            <div className="relative z-10 flex justify-between items-center mb-6"><h2 className="text-xl font-black flex items-center text-emerald-400"><Info className="w-5 h-5 mr-2.5" /> {text.sections.about_title}</h2></div>
            <div className="relative z-10 mb-4">
              <p className="text-slate-300 leading-relaxed mb-3 text-xs md:text-sm font-medium">{text.about.p1}</p>
              <p className="text-slate-300 leading-relaxed mb-3 text-xs md:text-sm font-medium">{text.about.p2}</p>
              <div className="mt-4 pt-5 border-t border-slate-700/50">
                <p className="text-emerald-50 leading-relaxed mb-4 text-xs md:text-sm font-medium">{text.about.expanded_p1}</p>
                <p className="text-emerald-50 leading-relaxed text-xs md:text-sm font-medium">{text.about.expanded_p2}</p>
              </div>
            </div>
            <div className="relative z-10 bg-slate-800/80 p-4 rounded-xl border border-slate-700 mt-6">
              <div className="flex items-center space-x-2 mb-1.5"><Quote className="w-3.5 h-3.5 text-emerald-500" /><h4 className="text-[10px] font-black uppercase tracking-widest text-slate-400">{text.about.citation_title}</h4></div>
              <p className="text-xs text-slate-300 font-serif italic border-l-2 border-emerald-500 pl-2.5">{text.about.citation_text}</p>
            </div>
          </div>
          
          <div className="bg-white rounded-3xl p-8 md:p-10 border shadow-sm relative border-slate-200">
            <div className="flex justify-between items-center mb-6"><h2 className="text-xl font-black text-slate-900 flex items-center"><BookOpen className="w-5 h-5 mr-2.5 text-emerald-600" /> {text.sections.method_title}</h2></div>
            <p className="text-slate-600 text-xs md:text-sm font-medium leading-relaxed mb-2">{text.method.summary}</p>
            <div className="mt-6 pt-6 border-t border-slate-100">
              <ul className="space-y-5">
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-emerald-500 mr-3 shrink-0 mt-0.5" /><p className="text-slate-700 text-xs md:text-sm font-medium leading-relaxed"><strong className="text-slate-900">{lang === 'fr' ? '1. Sourcing : ' : '1. Sourcing: '}</strong>{text.method.m1}</p></li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-emerald-500 mr-3 shrink-0 mt-0.5" /><p className="text-slate-700 text-xs md:text-sm font-medium leading-relaxed"><strong className="text-slate-900">{lang === 'fr' ? '2. Analyse Proportionnelle : ' : '2. Proportional Analysis: '}</strong>{text.method.m2}</p></li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-emerald-500 mr-3 shrink-0 mt-0.5" /><p className="text-slate-700 text-xs md:text-sm font-medium leading-relaxed"><strong className="text-slate-900">{lang === 'fr' ? '3. Modélisation Comparative : ' : '3. Comparative Modeling: '}</strong>{text.method.m3}</p></li>
                <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-emerald-500 mr-3 shrink-0 mt-0.5" /><p className="text-slate-700 text-xs md:text-sm font-medium leading-relaxed"><strong className="text-slate-900">{lang === 'fr' ? '4. Open Source & Intégrité : ' : '4. Open Source & Integrity: '}</strong>{text.method.m4}</p></li>
              </ul>
            </div>
            
            <div className="mt-8 pt-6 border-t border-slate-100">
              <h4 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-4">{text.method.sources_title}</h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <a href="https://www.un.org/development/desa/pd/data/international-migrant-stock" target="_blank" rel="noopener noreferrer" className="flex items-center p-3 rounded-lg bg-slate-50 border border-slate-100 hover:border-emerald-300 hover:bg-emerald-50 transition-colors group">
                  <Database className="w-4 h-4 text-emerald-500 mr-3 shrink-0" />
                  <span className="text-xs font-bold text-slate-700 group-hover:text-emerald-700">{text.method.s1}</span>
                </a>
                <a href="https://www.unhcr.org/refugee-statistics/" target="_blank" rel="noopener noreferrer" className="flex items-center p-3 rounded-lg bg-slate-50 border border-slate-100 hover:border-emerald-300 hover:bg-emerald-50 transition-colors group">
                  <Users className="w-4 h-4 text-emerald-500 mr-3 shrink-0" />
                  <span className="text-xs font-bold text-slate-700 group-hover:text-emerald-700">{text.method.s2}</span>
                </a>
                <a href="https://www.internal-displacement.org/database/displacement-data/" target="_blank" rel="noopener noreferrer" className="flex items-center p-3 rounded-lg bg-slate-50 border border-slate-100 hover:border-emerald-300 hover:bg-emerald-50 transition-colors group">
                  <MapPin className="w-4 h-4 text-emerald-500 mr-3 shrink-0" />
                  <span className="text-xs font-bold text-slate-700 group-hover:text-emerald-700">{text.method.s3}</span>
                </a>
                <a href="https://www.iom.int/" target="_blank" rel="noopener noreferrer" className="flex items-center p-3 rounded-lg bg-slate-50 border border-slate-100 hover:border-emerald-300 hover:bg-emerald-50 transition-colors group">
                  <Globe className="w-4 h-4 text-emerald-500 mr-3 shrink-0" />
                  <span className="text-xs font-bold text-slate-700 group-hover:text-emerald-700">{text.method.s4}</span>
                </a>
                <a href="https://normlex.ilo.org/" target="_blank" rel="noopener noreferrer" className="flex items-center p-3 rounded-lg bg-slate-50 border border-slate-100 hover:border-emerald-300 hover:bg-emerald-50 transition-colors group sm:col-span-2">
                  <FileText className="w-4 h-4 text-emerald-500 mr-3 shrink-0" />
                  <span className="text-xs font-bold text-slate-700 group-hover:text-emerald-700">{text.method.s5}</span>
                </a>
              </div>
            </div>
      ...
      {showModal && (
        <div 
          ...
          className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-5 bg-slate-900/90 backdrop-blur-sm animate-in fade-in duration-300 print:bg-white print:p-0 print:absolute print:inset-0 print:block"
        >
          <div 
            onClick={(e) => e.stopPropagation()} 
            className="bg-slate-50 rounded-3xl w-full max-w-5xl max-h-[95vh] overflow-hidden shadow-2xl flex flex-col print:shadow-none print:max-h-none print:rounded-none"
          >
            ...
            <div className="p-6 border-b border-slate-200 flex flex-col md:flex-row md:justify-between md:items-center bg-white print:border-b-2 print:border-slate-900 print:pb-4 gap-5 print:break-inside-avoid">
              <div className="flex items-center space-x-5">
                <span className="text-4xl md:text-5xl drop-shadow-md print:drop-shadow-none flag-emoji">{display.flag}</span>
                <div>
                  <h2 className="text-2xl md:text-3xl font-black text-slate-900 uppercase tracking-tighter">{display.name}</h2>
                  <p className="text-xs font-black text-emerald-600 uppercase tracking-widest mt-0.5">{display.isRegion ? (text.modal.south_view || "") : text.modal.raw_data_title}</p>
                </div>
              </div>
              
              {/* BOUTONS D'ONGLETS */}
              <div className="flex bg-slate-100 p-1 rounded-lg print:hidden">
                <button onClick={() => setModalView('demography')} className={`px-3 py-1.5 rounded-md text-xs font-bold transition-all ${modalView === 'demography' ? 'bg-white text-emerald-600 shadow-sm' : 'text-slate-500 hover:text-slate-800'}`}>{text.modal.tabs.demo}</button>
                <button onClick={() => setModalView('geography')} className={`px-3 py-1.5 rounded-md text-xs font-bold transition-all ${modalView === 'geography' ? 'bg-white text-emerald-600 shadow-sm' : 'text-slate-500 hover:text-slate-800'}`}>{text.modal.tabs.geo}</button>
                <button onClick={() => setModalView('economy')} className={`px-3 py-1.5 rounded-md text-xs font-bold transition-all ${modalView === 'economy' ? 'bg-white text-emerald-600 shadow-sm' : 'text-slate-500 hover:text-slate-800'}`}>{text.modal.tabs.econ}</button>
              </div>
              <button onClick={() => setShowModal(false)} className="absolute top-6 right-6 p-2 bg-white hover:bg-slate-100 rounded-full border border-slate-200 transition-colors print:hidden shadow-sm"><X className="w-4 h-4 text-slate-600" /></button>
            </div>
            ...
            <div className="p-6 md:p-10 overflow-y-auto space-y-10 print:overflow-visible print:p-0 print:pt-6 bg-slate-50 print:bg-white h-full print:flex print:flex-col print:gap-6 print:space-y-0">
              ...
              <div className={`grid-cols-1 lg:grid-cols-2 gap-8 animate-in fade-in duration-500 ${modalView === 'demography' ? 'grid' : 'hidden print:grid'} print:gap-4 print:mb-6`}>
                <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-sm print:border print:p-4">
                  <h3 className="font-black text-slate-900 mb-1.5 flex items-center text-lg"><Users className="w-5 h-5 mr-2.5 text-emerald-500 print:w-4 print:h-4" /> {lang === 'fr' ? "Le Réel Poids Démographique" : "The Real Demographic Weight"}</h3>
                  <p className="text-xs text-slate-500 font-medium mb-6 print:mb-3">{lang === 'fr' ? "La population migrante comparée à la population totale." : "Migrant population compared to total population."}</p>
                  <div className="relative pt-6 pb-3 print:pt-4">
                    <div className="h-12 w-full bg-slate-100 rounded-lg relative overflow-hidden flex items-center print:h-8 print:!bg-slate-100">
                      <span className="absolute right-3 text-[10px] font-black text-slate-400">POPULATION TOTALE</span>
                      <div className="h-full bg-emerald-500 flex items-center px-3 transition-all duration-1000 print:!bg-emerald-500" style={{width: `${Math.max(5, parseFloat(display.evolution))}%`}}>
                        <span className="text-white font-black text-base drop-shadow-sm print:text-xs">{display.evolution}%</span>
                      </div>
                    </div>
                  </div>
                  <div className="mt-6 pt-5 border-t border-slate-100 print:mt-3 print:pt-3">
                    <h4 className="font-black text-slate-800 text-xs mb-2 uppercase tracking-widest print:text-[9px]">{text.modal.evo_title}</h4>
                    <HistoricalChart data={display.history} colorClass="bg-emerald-500" />
                  </div>
                </div>
                
                <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-center items-center print:border print:p-4">
                   <h3 className="font-black text-slate-900 mb-6 flex items-center text-lg w-full print:mb-3"><HeartPulse className="w-5 h-5 mr-2.5 text-purple-500 print:w-4 print:h-4" /> {text.modal.parity}</h3>
                   <div className="relative w-40 h-40 rounded-full flex items-center justify-center shadow-inner print:w-24 print:h-24" style={{ background: `conic-gradient(#a855f7 ${display.female}%, #f1f5f9 0)` }}>
                     <div className="absolute inset-4 bg-white rounded-full flex flex-col items-center justify-center shadow-sm">
                       <span className="text-3xl font-black text-slate-900 tracking-tighter print:text-xl">{display.female}%</span>
                       <span className="text-[9px] font-black text-purple-500 uppercase mt-0.5 tracking-widest">{lang === 'fr' ? "Femmes" : "Women"}</span>
                     </div>
                   </div>
                   <p className="text-center text-xs font-medium text-slate-500 mt-6 max-w-xs leading-relaxed print:mt-3 print:text-[10px]">{lang === 'fr' ? "La migration n'est pas qu'une affaire d'hommes fuyant la misère. Elle est structurellement féminisée." : "Migration is not just men fleeing poverty. It is structurally feminized."}</p>
                </div>
              </div>
              ...
              <div className={`grid-cols-1 lg:grid-cols-5 gap-8 animate-in fade-in duration-500 ${modalView === 'geography' ? 'grid' : 'hidden print:grid'} print:gap-4 print:mb-6`}>
                ...
                <div className="lg:col-span-2 bg-slate-900 rounded-2xl p-7 text-white shadow-lg flex flex-col justify-center items-center print:bg-white print:text-slate-900 print:border print:border-slate-200 print:p-4 print:shadow-none">
                  <h3 className="font-black text-white print:text-slate-900 mb-6 flex items-center text-lg w-full print:mb-3"><Globe className="w-5 h-5 mr-2.5 text-teal-400 print:w-4 print:h-4" /> {text.modal.retention_title}</h3>
                  <div className="relative w-40 h-40 rounded-full flex items-center justify-center shadow-2xl print:shadow-inner print:w-24 print:h-24" style={{ background: `conic-gradient(#14b8a6 ${display.retention}%, ${display.isRegion ? '#3b82f6' : '#334155'} 0)` }}>
                    <div className="absolute inset-4 bg-slate-900 print:bg-white rounded-full flex flex-col items-center justify-center">
                      <span className="text-3xl font-black text-white print:text-slate-900 tracking-tighter print:text-xl">{display.retention}%</span>
                      <span className="text-[9px] font-black text-teal-400 uppercase mt-0.5 tracking-widest text-center px-2">{lang === 'fr' ? "Restent dans la région" : "Stay in the region"}</span>
                    </div>
                  </div>
                </div>
                
                <div className="lg:col-span-3 bg-white rounded-2xl border border-slate-200 p-7 shadow-sm flex flex-col justify-between print:p-4 print:break-inside-avoid">
                  <div>
                    <h3 className="font-black text-slate-900 mb-4 flex items-center text-xl print:mb-2 print:text-lg"><GitMerge className="w-5 h-5 mr-2.5 text-emerald-600 print:w-4 print:h-4" /> {text.modal.orig_dest_title}</h3>
                    <p className="text-slate-700 font-medium text-base leading-relaxed print:text-xs">{display.origDest}</p>
                    <div className="mt-4 pt-4 border-t border-slate-100 print:mt-2 print:pt-2">
                      <p className="text-xs text-slate-500 font-medium italic print:text-[10px]">{lang === 'fr' ? "Cette dynamique prouve que les pays du Sud sont avant tout des pays d'accueil et de passage interne." : "This dynamic proves that Southern countries are primarily host and internal passage countries."}</p>
                    </div>
                  </div>
                  ...
                  {!display.isRegion && (
                    <div className="mt-6 flex flex-col gap-4 print:mt-3 print:gap-2">
                      ...
                      {(display.idp_conflict > 0 || display.idp_disaster > 0 || display.refugees_hosted > 0) && (
                        <div className="bg-slate-50 p-5 rounded-xl border border-slate-200 print:p-3">
                          <h4 className="font-black text-slate-800 text-sm mb-4 flex items-center print:text-xs print:mb-2"><ShieldAlert className="w-4 h-4 mr-2 text-slate-500" /> {text.modal.idp_title}</h4>
                          <div className="space-y-4 print:space-y-2">
                            {display.refugees_hosted > 0 && (
                              <div>
                                <div className="flex justify-between text-[10px] font-black uppercase tracking-widest mb-1.5 print:text-[8px]">
                                  <span className="text-emerald-600 print:!text-emerald-600">{text.modal.hcr_hosted}</span>
                                  <span className="text-emerald-700 print:!text-emerald-700">{formatNumber(display.refugees_hosted)}</span>
                                </div>
                                <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden print:h-1.5 print:!bg-slate-200"><div className="h-full bg-emerald-500 rounded-full print:!bg-emerald-500" style={{width: '100%'}}></div></div>
                              </div>
                            )}
                            {display.idp_conflict > 0 && (
                              <div>
                                <div className="flex justify-between text-[10px] font-black uppercase tracking-widest mb-1.5 print:text-[8px]">
                                  <span className="text-rose-600 print:!text-rose-600">{text.modal.idp_conflict}</span>
                                  <span className="text-rose-700 print:!text-rose-700">{formatNumber(display.idp_conflict)}</span>
                                </div>
                                <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden print:h-1.5 print:!bg-slate-200"><div className="h-full bg-rose-500 rounded-full print:!bg-rose-500" style={{width: '100%'}}></div></div>
                              </div>
                            )}
                            {display.idp_disaster > 0 && (
                              <div>
                                <div className="flex justify-between text-[10px] font-black uppercase tracking-widest mb-1.5 print:text-[8px]">
                                  ...
                                  <span className="text-blue-700 print:!text-blue-700">{formatNumber(display.idp_disaster)}</span>
                                </div>
                                <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden print:h-1.5 print:!bg-slate-200"><div className="h-full bg-blue-500 rounded-full print:!bg-blue-500" style={{width: '100%'}}></div></div>
                              </div>
                            )}
                          </div>
                      ...
                      {display.avoi !== null && (
                        <div className="bg-slate-50 p-5 rounded-xl border border-slate-200 print:p-3">
                          <h4 className="font-black text-slate-800 text-sm mb-4 flex items-center print:text-xs print:mb-2"><Unlock className="w-4 h-4 mr-2 text-indigo-500" /> {text.modal.avoi_title}</h4>
                          <div>
                            <div className="flex justify-between text-[10px] font-black uppercase tracking-widest mb-1.5 print:text-[8px]">
                              <span className="text-indigo-600 print:!text-indigo-600">Score</span>
                              <span className="text-indigo-700 print:!text-indigo-700">{display.avoi}/100</span>
                            </div>
                            <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden print:h-1.5 print:!bg-slate-200">
                              <div className="h-full bg-indigo-500 rounded-full transition-all duration-1000 print:!bg-indigo-500" style={{width: `${display.avoi}%`}}></div>
                            </div>
                            <p className="text-[10px] text-slate-400 mt-2 italic print:text-[8px] print:mt-1.5">{text.modal.avoi_desc}</p>
                          </div>
                        </div>
                      )}
                    </div>
              ...
              <div className={`space-y-8 animate-in fade-in duration-500 ${modalView === 'economy' ? 'block' : 'hidden print:block'} print:space-y-4 print:break-inside-avoid`}>
                <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-sm print:p-4">
                  <h3 className="font-black text-slate-900 mb-1.5 flex items-center text-lg"><Landmark className="w-5 h-5 mr-2.5 text-amber-500 print:w-4 print:h-4" /> {text.modal.econ_title}</h3>
                  <p className="text-xs text-slate-500 font-medium mb-6 print:mb-3">{lang === 'fr' ? "L'apport des diasporas face à l'Assistance Publique au Développement (APD)." : "Diaspora contribution vs. Official Development Assistance (ODA)."}</p>
                  <div className="max-w-2xl"><EconomicComparison remittances={display.remittances} aid={display.aid} lang={lang} /></div>
                  <div className="mt-6 bg-amber-50 p-4 rounded-xl border border-amber-100 print:mt-3 print:p-2"><p className="text-amber-800 font-medium text-xs print:text-[10px]">{lang === 'fr' ? "Les diasporas injectent massivement du capital directement dans l'économie réelle (familles, santé, éducation), rendant les Suds économiquement résilients sans dépendre exclusivement de la charité internationale." : "Diasporas inject massive capital directly into the real economy, making the Souths economically resilient without depending solely on international charity."}</p></div>
                </div>

                {/* BLOC INSTRUMENTS ET TRAITÉS CLÉS DE L'UNION AFRICAINE */}
                {display.au_treaties && (
                  <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-sm print:p-4">
                    <h3 className="font-black text-slate-900 mb-1.5 flex items-center text-lg"><FileText className="w-5 h-5 mr-2.5 text-emerald-600 print:w-4 print:h-4" /> {text.modal.au_instruments}</h3>
                    <p className="text-xs text-slate-500 font-medium mb-6 print:mb-3">{lang === 'fr' ? "État de ratification des conventions phares de l'OUA/UA en matière d'intégration et de mobilité." : "Ratification status of key OAU/AU conventions on integration and mobility."}</p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                      <div className={`p-3 rounded-xl border flex items-center justify-between ${display.au_treaties.constitutive ? 'bg-emerald-50/60 border-emerald-200 text-emerald-900' : 'bg-slate-50 border-slate-200 text-slate-500'}`}>
                        <span className="text-xs font-bold">Acte Constitutif UA</span>
                        <span className={`text-[10px] font-black uppercase px-2 py-0.5 rounded ${display.au_treaties.constitutive ? 'bg-emerald-200 text-emerald-800' : 'bg-slate-200 text-slate-600'}`}>{display.au_treaties.constitutive ? 'Ratifié' : 'Non ratifié'}</span>
                      </div>
                      <div className={`p-3 rounded-xl border flex items-center justify-between ${display.au_treaties.abuja ? 'bg-emerald-50/60 border-emerald-200 text-emerald-900' : 'bg-slate-50 border-slate-200 text-slate-500'}`}>
                        <span className="text-xs font-bold">Traité d'Abuja (AEC)</span>
                        <span className={`text-[10px] font-black uppercase px-2 py-0.5 rounded ${display.au_treaties.abuja ? 'bg-emerald-200 text-emerald-800' : 'bg-slate-200 text-slate-600'}`}>{display.au_treaties.abuja ? 'Ratifié' : 'Non ratifié'}</span>
                      </div>
                      <div className={`p-3 rounded-xl border flex items-center justify-between ${display.au_treaties.refugees_1969 ? 'bg-emerald-50/60 border-emerald-200 text-emerald-900' : 'bg-slate-50 border-slate-200 text-slate-500'}`}>
                        <span className="text-xs font-bold">Conv. Réfugiés (1969)</span>
                        <span className={`text-[10px] font-black uppercase px-2 py-0.5 rounded ${display.au_treaties.refugees_1969 ? 'bg-emerald-200 text-emerald-800' : 'bg-slate-200 text-slate-600'}`}>{display.au_treaties.refugees_1969 ? 'Ratifié' : 'Non ratifié'}</span>
                      </div>
                      <div className={`p-3 rounded-xl border flex items-center justify-between ${display.au_treaties.kampala ? 'bg-emerald-50/60 border-emerald-200 text-emerald-900' : 'bg-slate-50 border-slate-200 text-slate-500'}`}>
                        <span className="text-xs font-bold">Conv. de Kampala (IDPs)</span>
                        <span className={`text-[10px] font-black uppercase px-2 py-0.5 rounded ${display.au_treaties.kampala ? 'bg-emerald-200 text-emerald-800' : 'bg-slate-200 text-slate-600'}`}>{display.au_treaties.kampala ? 'Ratifié' : 'Non ratifié'}</span>
                      </div>
                      <div className={`p-3 rounded-xl border flex items-center justify-between ${display.au_treaties.free_movement ? 'bg-emerald-50/60 border-emerald-200 text-emerald-900' : 'bg-slate-50 border-slate-200 text-slate-500'}`}>
                        <span className="text-xs font-bold">Protocole Libre Circ.</span>
                        <span className={`text-[10px] font-black uppercase px-2 py-0.5 rounded ${display.au_treaties.free_movement ? 'bg-emerald-200 text-emerald-800' : 'bg-slate-200 text-slate-600'}`}>{display.au_treaties.free_movement ? 'Ratifié' : 'Non ratifié'}</span>
                      </div>
                      <div className={`p-3 rounded-xl border flex items-center justify-between ${display.au_treaties.zlecaf ? 'bg-emerald-50/60 border-emerald-200 text-emerald-900' : 'bg-slate-50 border-slate-200 text-slate-500'}`}>
                        <span className="text-xs font-bold">Accord ZLECAf</span>
                        <span className={`text-[10px] font-black uppercase px-2 py-0.5 rounded ${display.au_treaties.zlecaf ? 'bg-emerald-200 text-emerald-800' : 'bg-slate-200 text-slate-600'}`}>{display.au_treaties.zlecaf ? 'Ratifié' : 'Non ratifié'}</span>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {display.normlex && (
                  <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-sm print:p-4">
                    <h3 className="font-black text-slate-900 mb-1.5 flex items-center text-lg"><Scale className="w-5 h-5 mr-2.5 text-indigo-600 print:w-4 print:h-4" /> {lang === 'fr' ? "Évaluation Juridique des Droits (Base NORMLEX OIT)" : "Legal Evaluation of Rights (ILO NORMLEX)"}</h3>
                    <p className="text-xs text-slate-500 font-medium mb-6 print:mb-3">{lang === 'fr' ? "Ratification des conventions internationales du travail et protection des travailleurs." : "Ratification of international labor standards and worker protection."}</p>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 print:grid-cols-4">
                      <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 text-center print:p-2">
                        <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 block mb-1">{lang === 'fr' ? "Fondamentales" : "Fundamental"}</span>
                        <span className="text-xl font-black text-emerald-600 print:text-sm">{display.normlex.fundamental} / 11</span>
                      </div>
                      <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 text-center print:p-2">
                        <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 block mb-1">{lang === 'fr' ? "Gouvernance" : "Governance"}</span>
                        <span className="text-xl font-black text-indigo-600 print:text-sm">{display.normlex.governance} / 4</span>
                      </div>
                      <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 text-center print:p-2">
                        <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 block mb-1">{lang === 'fr' ? "Techniques" : "Technical"}</span>
                        <span className="text-xl font-black text-blue-600 print:text-sm">{display.normlex.technical}</span>
                      </div>
                      <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 text-center print:p-2">
                        <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 block mb-1">{lang === 'fr' ? "Total Ratifications" : "Total Ratified"}</span>
                        <span className="text-xl font-black text-slate-900 print:text-sm">{display.normlex.total}</span>
                      </div>
                    </div>
                  </div>
                )}
                
                <div className="bg-slate-900 p-7 rounded-2xl text-white relative overflow-hidden shadow-lg print:bg-white print:text-slate-900 print:shadow-none print:border print:border-slate-200 print:p-4 print:break-inside-avoid">
                  <h3 className="text-lg font-black mb-6 border-b border-slate-700 pb-3 print:border-slate-200 print:mb-3 print:pb-2 print:text-base">{text.modal.causal_chain}</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10 print:gap-3">
                    <div className="bg-slate-800/50 p-5 rounded-xl print:bg-slate-50 print:border print:border-slate-200 print:p-3">
                      <span className="text-emerald-400 print:text-emerald-600 font-black text-[10px] uppercase tracking-widest mb-2 block">{text.modal.trigger}</span>
                      <p className="text-sm font-medium leading-relaxed print:text-xs">{display.trigger}</p>
                    </div>
                    <div className="bg-slate-800/50 p-5 rounded-xl print:bg-slate-50 print:border print:border-slate-200 print:p-3">
                      <span className="text-emerald-400 print:text-emerald-600 font-black text-[10px] uppercase tracking-widest mb-2 block">{text.modal.response}</span>
                      <p className="text-sm font-medium leading-relaxed print:text-xs">{display.response}</p>
                    </div>
                    <div className="bg-slate-800/50 p-5 rounded-xl print:bg-slate-50 print:border print:border-slate-200 print:p-3">
                      <span className="text-emerald-400 print:text-emerald-600 font-black text-[10px] uppercase tracking-widest mb-2 block">{text.modal.impact}</span>
                      <p className="text-sm font-medium leading-relaxed print:text-xs">{display.impact}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="p-5 bg-white border-t border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-3 print:hidden">
              <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest hidden md:block">{text.modal.data_source}</span>
              <div className="flex items-center space-x-2 w-full sm:w-auto justify-end">
                <button onClick={exportCountryProfileCSV} className="flex-1 sm:flex-none flex items-center justify-center space-x-1.5 bg-slate-50 border border-slate-200 text-slate-700 hover:text-emerald-600 px-4 py-2 rounded-lg text-[11px] font-bold transition-colors shadow-sm"><Download className="w-3.5 h-3.5" /> <span>{text.modal.export_csv}</span></button>
                <button onClick={() => window.print()} className="flex-1 sm:flex-none flex items-center justify-center space-x-1.5 bg-slate-900 text-white hover:bg-emerald-600 px-4 py-2 rounded-lg text-[11px] font-bold transition-colors shadow-sm"><Printer className="w-3.5 h-3.5" /> <span>{text.modal.export_pdf}</span></button>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* FOOTER */}
      <footer className="bg-slate-900 text-slate-400 py-12 border-t border-slate-800 mt-12 print:hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
          <div>
            <div className="flex items-center space-x-2 mb-2 justify-center md:justify-start">
              <Globe className="h-5 w-5 text-emerald-500" />
              <span className="text-white font-black text-lg tracking-widest uppercase">South(s) Mobility</span>
            </div>
            <p className="text-xs font-medium">{text.footer.tag}</p>
          </div>
          <div className="text-[9px] uppercase font-black tracking-widest text-slate-500">
            <p>{text.footer.sources}</p>
            <p className="mt-3 text-emerald-600">© 2026 • Yassine Ben Mokhtar • Projet Citoyen Indépendant</p>
          </div>
        </div>
      </footer>
    </div>
