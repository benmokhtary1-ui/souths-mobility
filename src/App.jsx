  ...
  const legalMatrixData = [
    {
      ...
      countries: [
        ...
        },
        {
          ...
          details: [
            { label: "Analyse Juridique", text: "Les visas touristiques standard sont généralement délivrés pour 30 jours. Toutefois, la loi catégorise la résidence en trois niveaux temporels distincts : « Spéciale », « Ordinaire » et « Temporaire »." },
            { label: "Mécanisme de Transition", text: "Un visiteur souhaitant rester doit demander un permis de résidence temporaire (souvent valide pour 6 mois à 1 an) avant l'expiration de son visa touristique. Récemment, des décrets (ex: Décret 3326 de 2023) ont instauré une période de grâce pour la régularisation des résidents illégaux moyennant le paiement d'amendes (env. 1 000 USD), soulignant la volonté de l'État d'imposer le permis de résidence." }
          ]
        },
        {
          name: "Libye", threshold: "90 Jours (3 Mois)", tableNotes: "Visa de Résidence requis pour séjours > 3 mois.",
        ...
        {
          name: "Maroc", threshold: "90 Jours", tableNotes: "Extension possible, mais carte d'immatriculation requise > 90 jours.",
          instrument: "Loi n° 02-03 du 11 novembre 2003 relative à l'entrée et au séjour des étrangers au Royaume du Maroc.",
          details: [
            { label: "Analyse Juridique", text: "L'article 8 de la Loi 02-03 stipule explicitement que tout étranger souhaitant séjourner sur le territoire marocain pour une durée supérieure à 90 jours est tenu de demander une « Carte d'Immatriculation »." },
            { label: "Sanctions", text: "Le dépassement de ce seuil de 90 jours sans dépôt de demande de carte constitue une infraction. Bien que des prolongations de visa soient possibles pour des motifs exceptionnels, la norme juridique fixe la fin du statut de simple visiteur au 90e jour." }
          ]
        ...
        {
          name: "Mauritanie", threshold: "90 Jours", tableNotes: "Carte de séjour requise après 90 jours.",
          instrument: "Loi n° 1965-046 fixant les dispositions applicables à l'admission et au séjour des étrangers.",
          details: [
            { label: "Analyse Juridique", text: "Les visas sont délivrés pour des durées de 30 à 90 jours. Un étranger désirant rester au-delà de la durée du visa doit obligatoirement solliciter une « Carte de Séjour »." },
            { label: "Réforme", text: "Récemment, la validité de la carte de séjour a été étendue d'un an à cinq ans, facilitant la vie des résidents à long terme, mais le seuil d'entrée déclenchant cette obligation demeure l'expiration du visa court séjour. Le système « e-visa » facilite l'entrée mais ne confère aucun droit de résidence." }
          ]
    ...
    {
      region: "Afrique de l'Ouest",
      intro: "L'Afrique de l'Ouest présente un régime d'immigration dual : l'un pour les citoyens de la CEDEAO et l'autre pour les ressortissants tiers (étrangers). Le Protocole A/P.1/5/79 de la CEDEAO établit un privilège de 90 jours sans visa, qui est devenu le seuil de facto pour définir le « visiteur » dans toute la région. Reste la zone la plus intégrée avec 15 pays offrant une libre circulation totale.",
      countries: [
        {
          name: "Bénin", threshold: "90 Jours", tableNotes: "Carte de séjour requise après 90 jours.",
          instrument: "Loi n° 2025-15 relative aux conditions d'entrée, de séjour et d'établissement des étrangers.",
          details: [
            { label: "Analyse", text: "Les e-visas de court séjour sont disponibles pour 30 ou 90 jours." },
            { label: "Obligation", text: "« Tout étranger souhaitant séjourner [...] pour une période excédant 90 jours doit détenir une carte de séjour ». La nouvelle Loi 2025-15 renforce ces conditions, maintenant le seuil de 90 jours comme la ligne de démarcation entre visiteur et résident." }
          ]
        ...
        {
          name: "Burkina Faso", threshold: "90 Jours", tableNotes: "Permis de résidence requis après 90 jours.",
          instrument: "Loi de 2024 portant réglementation de l'entrée et du séjour des étrangers.",
          details: [
            { label: "Analyse", text: "« Tout étranger souhaitant séjourner au Burkina Faso pour une période excédant quatre-vingt-dix (90) jours doit détenir soit un visa long séjour, soit un permis de résidence »." },
            { label: "Transition", text: "Le visa long séjour (valide 1 an) ou la « Carte de Résident » est requis immédiatement après l'expiration de la période visiteur de 90 jours. La loi de 2024 a durci les contrôles aux frontières." }
          ]
        },
        {
          ...
          instrument: "Loi n° 66/VIII/2014.",
          details: [
            { label: "Analyse", text: "Les visas touristiques permettent un séjour jusqu'à 90 jours, prolongeable une fois pour une période similaire. Pour les citoyens exemptés de visa (UE/UK), l'enregistrement EASE permet 30 jours, extensibles." },
            { label: "Obligation", text: "Les séjours dépassant la limite du visa (90 jours) nécessitent une « Autorização de Residência » (Temporaire ou Permanente). La loi distingue strictement le « Visa » de la « Résidence ». Des changements récents facilitent l'accès à la résidence pour les citoyens de la CPLP." }
          ]
        },
        {
          name: "Côte d'Ivoire", threshold: "90 Jours (3 Mois)", tableNotes: "Titre de séjour obligatoire après 3 mois.",
          instrument: "Loi n° 2004-303 (modifiant la loi n° 2002-03).",
          details: [
            { label: "Analyse", text: "Un permis de résidence (« Titre de Séjour ») est obligatoire pour quiconque a l'intention de séjourner plus de trois mois." },
            { label: "Obligation", text: "Cela s'applique aux travailleurs, étudiants et dépendants. La « Carte de Résident » est valide 5 ans pour les nationaux CEDEAO et 1 an pour les autres (renouvelable). Le système est biométrique et exige une présence physique à l'Office National d'Identification (ONI)." }
          ]
        },
        {
          name: "Gambie", threshold: "28-90 Jours", tableNotes: "Non-CEDEAO besoin permis après 56-90 jours.",
          ...
          details: [
            { label: "Entrée Standard", text: "Les visiteurs reçoivent généralement un tampon de 28 jours initialement, extensible." },
            { label: "Nationaux non-CEDEAO", text: "Sont tenus d'obtenir un permis de résidence (« Alien Card » + « Residential Permit B ») s'ils séjournent au-delà de 56 jours selon certaines sections des règlements, bien que 90 jours soit souvent la limite pratique maximale pour les extensions avant l'application stricte de la résidence." }
          ]
        },
        {
          name: "Ghana", threshold: "60-90 Jours", tableNotes: "Max 90 jours (CEDEAO). Permis résidence pour > 90 jours.",
          instrument: "Immigration Act, 2000 (Act 573).",
          details: [
            { label: "Analyse", text: "Les visiteurs se voient accorder un maximum de 60 jours initialement. Cela peut être étendu jusqu'à 90 jours. « Avant que son entrée ne soit autorisée [...] un séjour maximum de 60 jours (90 jours pour les nationaux CEDEAO) est accordé »." },
            { label: "Obligation", text: "Tout non-Ghanéen ayant l'intention de résider pour plus de 90 jours (ou une extension maximale de 6 mois) doit obtenir un permis de résidence. La résidence indéfinie est possible après 5 ans de résidence légale continue." }
          ]
        },
        {
          name: "Guinée", threshold: "90 Jours", tableNotes: "Carte de séjour requise après 90 jours.",
          instrument: "Loi L/94/019/CTRN portant sur les conditions d'entrée et de séjour des étrangers.",
          details: [
            { label: "Analyse", text: "Le « Visa de court séjour » est valide jusqu'à 90 jours." },
            { label: "Obligation", text: "Les étrangers ayant l'intention de rester plus longtemps doivent demander une « Carte de Séjour ». La validité du visa permet l'entrée, mais la carte est le document de résidence requis sur le territoire." }
          ]
        ...
        {
          name: "Guinée-Bissau", threshold: "90 Jours", tableNotes: "Permis de résidence requis après 90 jours.",
          instrument: "Loi n° 2/92 sur la citoyenneté et Décret-Loi sur les étrangers.",
          details: [
            { label: "Analyse", text: "Les visas à l'arrivée sont valides pour un maximum de 90 jours." },
            { label: "Obligation", text: "Pour les séjours dépassant cette période, une « Autorização de Residência » est requise. La loi mandate l'enregistrement pour tout séjour impliquant un établissement." }
          ]
        ...
        {
          name: "Liberia", threshold: "60 Jours", tableNotes: "Séjour initial 60 jours. Permis résidence pour plus long.",
          instrument: "Aliens and Nationality Law (Title 4 of the Liberian Code of Laws).",
          details: [
            { label: "Analyse", text: "« La période pour laquelle un visiteur étranger est autorisé à entrer au Liberia sera fixée [...] pour une période de 60 jours »." },
            { label: "Obligation", text: "Ce seuil est notablement plus court que la norme régionale de 90 jours. Des extensions sont possibles, mais pour tout séjour à long terme, un « Residence Permit » est requis immédiatement à l'expiration de l'admission visiteur de 60 jours." }
          ]
        },
        {
          name: "Mali", threshold: "90 Jours", tableNotes: "Carte de séjour requise après 90 jours.",
          instrument: "Loi n° 04-058 relative aux conditions d'entrée, de séjour et d'établissement des étrangers.",
          details: [
            { label: "Analyse", text: "Le « Visa Long Séjour » est requis pour les séjours excédant 90 jours." },
            { label: "Obligation", text: "Dès l'arrivée avec un visa long séjour (ou après 90 jours sur un visa régulier), l'étranger doit solliciter une « Carte de Séjour ». L'article 22 prévoit l'emprisonnement pour séjour sans permis." }
          ]
        ...
        {
          name: "Niger", threshold: "90 Jours", tableNotes: "Carte de séjour requise après 90 jours.",
          instrument: "Ordonnance n° 81-40 réglementant l'entrée et le séjour des étrangers.",
          details: [
            { label: "Analyse", text: "Les ressortissants étrangers ayant l'intention de séjourner plus de 90 jours doivent demander une « Carte de Séjour » (Permis de Résidence Temporaire)." },
            { label: "Procédure", text: "Cette ordonnance reste le socle du droit de l'immigration au Niger. Les citoyens de la CEDEAO nécessitent également des cartes de séjour pour l'établissement, bien que la procédure soit simplifiée." }
          ]
        },
        {
          ...
          details: [
            { label: "Analyse", text: "« Les Visas de Court Séjour permettent aux voyageurs de visiter le Nigeria pour une période n'excédant pas trois mois (90 jours) »." },
            { label: "Obligation", text: "Pour l'emploi ou la résidence au-delà de 56/90 jours, le CERPAC (Combined Expatriate Residence Permit and Alien Card) est obligatoire. Le seuil de 90 jours est une limite stricte pour les visites. Une mise à jour de 2025 a introduit des amendes de 15 USD/jour pour les dépassements." }
          ]
        },
        {
          name: "Sénégal", threshold: "90 Jours", tableNotes: "Carte d'identité d'étranger obligatoire après 90 jours.",
          instrument: "Loi n° 71-10 du 25 janvier 1971 relative aux conditions d'admission, de séjour et d'établissement.",
          details: [
            { label: "Analyse", text: "« Pour séjourner au Sénégal plus de 90 jours, vous devez obtenir une carte nationale d'identité étrangère (Carte d'Identité d'Étranger) »." },
            { label: "Note", text: "Ceci s'applique même aux ressortissants exemptés de visa (comme les Français ou citoyens CEDEAO). La marque des 90 jours est le déclencheur légal définitif pour l'enregistrement de résidence." }
          ]
        },
        {
          name: "Sierra Leone", threshold: "30-90 Jours", tableNotes: "Permis de résidence requis pour séjours > 90 jours.",
          ...
          details: [
            { label: "Analyse", text: "Les visas à entrer unique sont valides 90 jours à l'émission pour des visites jusqu'à un maximum de 30 jours." },
            { label: "Obligation", text: "« Un Permis de Travail & Résidence doit être obtenu dans les 30 jours suivant l'arrivée avant l'expiration du Visa d'Atterrissage » pour ceux qui ont l'intention de rester. C'est l'un des seuils les plus courts du continent." }
          ]
        },
        {
          name: "Togo", threshold: "90 Jours", tableNotes: "Carte de séjour requise après 90 jours.",
          instrument: "Loi relative à la police des étrangers (actualisée en 2022).",
          details: [
            { label: "Analyse", text: "Les visas touristiques sont valides jusqu'à 90 jours. « Tout étranger souhaitant séjourner [...] pour une période excédant 90 jours doit détenir une carte de séjour »." },
            { label: "Réforme", text: "La nouvelle loi de 2022 a renforcé les pénalités pour dépassement de séjour et rationalisé le processus de permis de résidence." }
          ]
    ...
    {
      region: "Afrique Centrale",
      intro: "La région CEMAC (Communauté Économique et Monétaire de l'Afrique Centrale) soutient théoriquement la libre circulation, mais la mise en œuvre nationale est caractérisée par une haute sécurisation. Le seuil pour les visiteurs est généralement de 90 jours, mais l'exigence de permis de résidence (souvent liée à des cautions de rapatriement) est strictement appliquée.",
      countries: [
        {
          name: "Cameroun", threshold: "90 Jours (3 Mois)", tableNotes: "Carte de séjour requise après 3 mois.",
          instrument: "Loi n° 97/012 du 10 janvier 1997 fixant les conditions d'entrée, de séjour et de sortie des étrangers.",
          details: [
            { label: "Analyse", text: "L'article 17 stipule : « Tout étranger [...] doit, dans un délai de trois (3) mois [...] se présenter aux autorités compétentes pour solliciter une carte de séjour »." },
            { label: "Mandat", text: "La marque des 3 mois est l'échéance statutaire pour demander une carte de séjour. Les visiteurs restant moins de ce délai sont des « visiteurs temporaires »." }
          ]
        ...
        {
          name: "Tchad", threshold: "90 Jours (3 Mois)", tableNotes: "Carte de séjour requise après 3 mois.",
          instrument: "Ordonnance n° 27-62 relative à l'entrée et au séjour des étrangers.",
          details: [
            { label: "Analyse", text: "Similaire aux autres États de la CEMAC, la période visiteur est plafonnée à 3 mois. « Une carte de séjour est requise pour les expatriés [...] la délivrance de ces documents légaux est interconnectée »." },
            { label: "Enregistrement", text: "L'enregistrement auprès de l'immigration est requis dans les 72 heures suivant l'arrivée, une mesure de sécurité commune au Sahel." }
          ]
        },
        {
          name: "Congo (Rep)", threshold: "90 Jours (3 Mois)", tableNotes: "Permis de résidence requis après 3 mois.",
          instrument: "Loi n° 23-96 fixant les conditions d'entrée, de séjour et de sortie des étrangers.",
          details: [
            { label: "Analyse", text: "« Les étrangers séjournant [...] devront dans les trois mois, se soumettre aux dispositions qui précèdent » (concernant la résidence)." },
            { label: "Exigence", text: "Un permis de résidence est obligatoire après l'expiration de la fenêtre visiteur de 3 mois." }
          ]
        ...
        {
          name: "RDC", threshold: "~6 Mois", tableNotes: "Visa voyage max 6 mois. Visa établissement pour résidence.",
          instrument: "Ordonnance-loi n° 83-033 relative à la police des étrangers.",
          details: [
            { label: "Analyse", text: "Le « Visa de Voyage » autorise un séjour jusqu'à 6 mois. C'est toutefois la limite supérieure pour un visiteur." },
            { label: "Obligation", text: "Pour l'« établissement » (résidence), un « Visa d'Établissement » spécifique est requis. Contrairement à d'autres États où 90 jours est la limite stricte, la RDC permet une validité de visa visiteur jusqu'à 6 mois, mais l'intention de résidence doit être déclarée plus tôt pour le visa d'établissement." }
          ]
        },
        {
          name: "Guinée Équatoriale", threshold: "90 Jours", tableNotes: "Permis de résidence requis après 90 jours.",
          instrument: "Loi organique n° 3/2010 réglementant l'entrée, le séjour et l'établissement des étrangers.",
          details: [
            { label: "Analyse", text: "« Les visas de court terme sont valides pour 90 jours. Pour des séjours plus longs, vous devez vous adresser aux postes de police locaux »." },
            { label: "Exigence", text: "Les permis de résidence sont requis pour tout séjour à long terme au-delà de la limite de 3 mois du visa. Les nationaux CEMAC peuvent entrer avec une CNI, mais le seuil de résidence de 90 jours s'applique également à eux pour l'établissement." }
          ]
        },
        {
          name: "Gabon", threshold: "90 Jours", tableNotes: "Carte de séjour requise après 90 jours.",
          instrument: "Loi n° 5/86 fixant les conditions d'entrée et de séjour des étrangers.",
          details: [
            { label: "Analyse", text: "« Les visiteurs qui souhaitent rester dans le pays pour plus de 90 jours doivent obtenir un permis de résidence (carte de séjour) »." },
            { label: "Application", text: "Stricte. Les visas de sortie ne sont plus requis pour les résidents, mais la carte de séjour est obligatoire après 3 mois." }
          ]
        },
        {
          ...
          details: [
            { label: "Analyse", text: "Les exemptions de visa sont souvent de 15 jours. Les visas touristiques sont généralement valides pour 30 jours." },
            { label: "Obligation", text: "Pour les séjours plus longs que ces courtes durées, un permis de résidence est requis. Le seuil initial de visiteur est notablement plus court que la moyenne continentale, exigeant une action administrative rapide pour les extensions." }
          ]
        }
      ]
    },
    {
      ...
      countries: [
        {
          name: "Burundi", threshold: "30 Jours (extensible)", tableNotes: "Permis de résidence généralement requis après 3 mois.",
          instrument: "Loi n° 1/13 du 22 septembre 2011 portant révision de la législation sur l'immigration.",
          details: [
            { label: "Analyse", text: "Les voyageurs obtiennent un visa de 30 jours à l'arrivée. Ceci peut être étendu. « Ceux qui restent plus de 30 jours peuvent aussi demander un visa de trois mois [...] Permis de résidence requis pour plus longtemps »." },
            { label: "Limite", text: "Le plafond visiteur est généralement fixé à 3 mois avant que le permis de résidence ne devienne nécessaire." }
          ]
        ...
        {
          name: "Comores", threshold: "45 Jours", tableNotes: "Visa à l'arrivée 45 jours. Permis résidence pour plus long.",
          instrument: "Loi n° 88-025 relative aux conditions d'entrée et de séjour des étrangers.",
          details: [
            { label: "Analyse", text: "Le visa à l'arrivée est valide pour 45 jours." },
            { label: "Obligation", text: "Tout étranger souhaitant rester au-delà de cette période doit demander un permis de résidence. C'est une durée spécifique à l'archipel, légèrement plus courte que les 90 jours standards." }
          ]
        ...
        {
          name: "Djibouti", threshold: "90 Jours", tableNotes: "Carte de séjour requise après 90 jours.",
          instrument: "Loi n° 201/AN/07 portant conditions d'entrée et de séjour.",
          details: [
            { label: "Analyse", text: "« La loi sur l'immigration djiboutienne permet aux visiteurs d'entrer et de rester pour 90 jours avec un eVisa »." },
            { label: "Obligation", text: "« Ceux souhaitant rester plus de 90 jours doivent travailler avec les autorités pour ajuster leur statut » (Carte de Séjour)." }
          ]
        ...
        {
          name: "Érythrée", threshold: "90 Jours (3 Mois)", tableNotes: "Permis de résidence requis après 3-6 mois.",
          instrument: "Proclamation n° 24/1992 issued to regulate the issuing of travel documents, entry and exit visa.",
          details: [
            { label: "Analyse", text: "« Un visa touristique [...] peut permettre au titulaire de rester en Érythrée pendant les trois mois »." },
            { label: "Obligation", text: "« Tout étranger qui [...] a séjourné pour pas plus de six mois doit demander un permis de résidence ». Bien que le visa touristique soit de 3 mois, la date limite absolue pour la résidence semble être de 6 mois." }
          ]
        },
        {
          ...
          details: [
            { label: "Analyse", text: "Lese-visas touristiques sont émis pour 30 ou 90 jours." },
            { label: "Obligation", text: "« Tout étranger qui [...] a l'intention de rester pour plus de quatre-vingt-dix jours [...] doit s'enregistrer dans les trente jours suivant son arrivée ». La marque des 90 jours est le seuil critique pour obtenir une ID de Résidence." }
          ]
        },
        {
          name: "Kenya", threshold: "90 Jours (extensible)", tableNotes: "Max 6 mois pass visiteur. Permis requis ensuite.",
        ...
        {
          name: "Madagascar", threshold: "90 Jours", tableNotes: "Carte de résident requise après 3 mois.",
          instrument: "Loi n° 62-006 sur l'organisation et le contrôle de l'immigration.",
          details: [
            { label: "Analyse", text: "« Les étrangers entrant à Madagascar pour une période n'excédant pas trois mois sont des non-immigrants »." },
            { label: "Obligation", text: "« Les étrangers séjournant [...] durant une période supérieure à trois mois sont des immigrants ». Ainsi, le seuil de résidence est de 3 mois." }
          ]
        },
        {
          ...
          details: [
            { label: "Analyse", text: "Les visas touristiques permettent un séjour cumulatif de 180 jours par an. Toutefois, une visite unique est souvent plafonnée à 90 jours." },
            { label: "Premium Visa", text: "Maurice a introduit un « Premium Visa » permettant un séjour d'1 an pour les nomades numériques, comblant l'écart entre visiteur et résident. Les permis de résidence standards sont pour l'emploi/investissement." }
          ]
        },
        {
          name: "Rwanda", threshold: "30-90 Jours", tableNotes: "Permis requis après 30/90 jours selon origine.",
          instrument: "Loi n° 57/2018 relative à l'immigration et à l'émigration.",
          details: [
            { label: "Analyse", text: "30 jours pour beaucoup de nationaux (Afrique entière) ; 90 jours pour les accords spécifiques (ex: CAE, UA)." },
            { label: "Obligation", text: "« Permis de résidence temporaire [...] période de grâce de 15 jours à l'arrivée [...] pour postuler ». Les visiteurs purs peuvent rester jusqu'à la validité de leur visa (30/90 jours). Les permis de résidence sont requis pour le travail ou les séjours au-delà de la validité du visa." }
          ]
        },
        {
          name: "Seychelles", threshold: "3 Mois", tableNotes: "Permis visiteur extensible jusqu'à 12 mois.",
          ...
          details: [
            { label: "Analyse", text: "Un permis visiteur est valide pour 3 mois initialement." },
            { label: "Extension", text: "De manière unique, il peut être étendu par tranches de 3 mois jusqu'à un maximum de 12 mois. On peut rester « visiteur » jusqu'à un an, mais cela exige une extension active tous les 3 mois. Le statut « Résidence » est une catégorie séparée pour l'établissement." }
          ]
        },
        {
          name: "Somalie", threshold: "30 Jours", tableNotes: "Permis de résidence requis pour plus long.",
          ...
          details: [
            { label: "Analyse", text: "Le visa à l'arrivée est valide pour 30 jours." },
            { label: "Obligation", text: "« Les visas long terme ont une durée qui excède 90 jours [...] les détenteurs de ces types de visas reçoivent la résidence ». La limite visiteur est courte (30 jours), exigeant extension ou conversion en résidence pour les séjours plus longs." }
          ]
        },
        {
          name: "Soudan", threshold: "90 Jours (3 Mois)", tableNotes: "Enregistrement étranger requis après 3 mois.",
          instrument: "Passports and Immigration Act de 1994.",
          details: [
            { label: "Analyse Juridique", text: "La loi dispose qu'« aucun visa n'est requis pour les visiteurs qui ne restent pas au Soudan plus de trois mois » (référence à l'exemption d'enregistrement pour courts séjours dans certains cas)." },
            { label: "Obligation de Résidence", text: "La section 25 impose que « tout étranger résidant au Soudan pour plus de trois mois doit s'adresser à l'officier d'enregistrement [...] pour se faire enregistrer ». Le seuil statutaire pour l'enregistrement de résidence est donc de 3 mois. De plus, les étrangers doivent signaler leur présence dans les 3 jours suivant l'arrivée." }
          ]
        },
        {
          name: "Soudan du Sud", threshold: "90 Jours (3 Mois)", tableNotes: "Permis de résidence requis après 3 mois.",
        ...
        {
          name: "Ouganda", threshold: "90 Jours", tableNotes: "Special Pass ou Entry Permit requis après 90 jours.",
          instrument: "Uganda Citizenship and Immigration Control Act (Cap. 66).",
          details: [
            { label: "Analyse", text: "« Un étranger en possession d'un pass visiteur valide ou spécial dont la période de séjour n'excède pas quatre-vingt-dix jours » est exempté de l'enregistrement des étrangers." },
            { label: "Obligation", text: "Les séjours au-delà de 90 jours nécessitent généralement un Special Pass (pour courtes extensions) ou un Entry Permit (Travail/Résidence)." }
          ]
    ...
    {
      region: "Afrique Australe",
      intro: "La région de la SADC (Communauté de Développement d'Afrique Australe) se caractérise par un calcul « jours par an » pour les visiteurs. Contrairement à d'autres régions où une sortie et réentrée (« border run ») réinitialise le compteur de 90 jours, les pays de la SADC comme l'Afrique du Sud et le Botswana appliquent souvent une limite annuelle agrégée pour empêcher la résidence de fait. Bien que plus lente, la zone Sud voit une multiplication des accords bilatéraux.",
      countries: [
        {
          name: "Angola", threshold: "90 Jours (Agrégé)", tableNotes: "30 jours par visite, max 90 jours/an.",
          instrument: "Loi n° 13/19 sur le régime juridique des étrangers en République d'Angola.",
          details: [
            { label: "Analyse", text: "Les visas touristiques sont valides pour 120 jours, permettant des entrées multiples pour un séjour de jusqu'à 30 jours par visite. Crucialement, le séjour total ne peut excéder 90 jours par an." },
            { label: "Obligation", text: "Les permis de résidence sont requis pour l'établissement au-delà de cette limite agrégée." }
          ]
        ...
        {
          name: "Mozambique", threshold: "90 Jours", tableNotes: "Nouvelle loi permet 90 jours. Résidence (DIRE) pour plus long.",
          instrument: "Loi n° 23/2022 sur l'immigration.",
          details: [
            { label: "Analyse", text: "« Les citoyens étrangers avec un visa touristique peuvent maintenant rester dans le pays pour une période de 90 jours, continus ou interrompus durant 12 mois »." },
            { label: "Obligation", text: "« Le Permis de Résidence Temporaire du Mozambique est requis pour les nationaux étrangers qui ont l'intention de rester [...] pour plus de trois mois »." }
          ]
        ...
        {
          name: "Zimbabwe", threshold: "90 Jours", tableNotes: "Max 90 jours touriste. Permis requis ensuite.",
          instrument: "Immigration Act (Chapter 4:02).",
          details: [
            { label: "Analyse", text: "« Vous pouvez demander 2 extensions consécutives (pour un total de 90 jours) »." },
            { label: "Obligation", text: "Les séjours au-delà de 90 jours exigent un permis (Étudiant, Emploi, ou Résidence)." }
          ]
  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
      ...
      <section className="bg-slate-50 rounded-xl p-6 md:p-8 shadow-sm">
        ...
        {/* ÉTATS JURIDIQUES ET MATRICE DES 54 PAYS */}
        {activeSdgzTab === 'matrix' && (
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="bg-slate-900 text-white p-6 md:p-8 rounded-xl shadow-md border border-slate-800">
              <span className="text-[10px] font-bold text-blue-400 uppercase tracking-widest block mb-2">
              ...
              <h3 className="font-serif font-bold text-2xl md:text-3xl mb-4 leading-tight">
                AN – Matrices de réciprocité des visas et profils d’entrée et de séjour (54 pays)
              </h3>
              <p className="text-slate-300 text-sm md:text-base leading-relaxed max-w-4xl">
                Le <strong>Tableau 26</strong> résume la durée légale « Visiteur » avant qu'un permis de résidence ou une extension ne soit obligatoire pour les 54 pays. L'analyse des seuils d'entrée démontre la persistance d'une frontière juridique stricte entre le statut de « visiteur » et celui d'« immigrant ».
              </p>
            </div>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-5 rounded-r-lg shadow-sm">
              <div className="flex items-start">
                <AlertCircle className="w-5 h-5 text-amber-600 mt-0.5 mr-3 shrink-0" />
                <div>
                  <h4 className="text-sm font-bold text-amber-900 mb-1">Notes méthodologiques [1] et [2]</h4>
                  <p className="text-xs text-amber-800 leading-relaxed">
                    [1] Ces infographies sont directement issues de l'Africa Visa Openness Index 2025 (BAD, 2026). Elles sont mobilisées ici comme support visuel pour contextualiser mon analyse des seuils administratifs et des pratiques nationales de contrôle.<br/><br/>
                    [2] Ce tableau de synthèse et les fiches détaillées par pays résultent d'une <strong>analyse comparative personnelle des instruments juridiques nationaux</strong> (Lois sur l'immigration et codes des étrangers) en vigueur sur le continent en 2025.
                  </p>
                </div>
              </div>
            </div>

            <div className="flex bg-slate-200 p-1.5 rounded-lg w-fit">
              <button onClick={() => setMatrixView('table')} className={`py-2 px-6 rounded-md text-xs font-bold transition-all flex items-center ${matrixView === 'table' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-800'}`}><TableProperties className="w-3.5 h-3.5 mr-2" /> Vue Tableau (Synthèse)</button>
              <button onClick={() => setMatrixView('details')} className={`py-2 px-6 rounded-md text-xs font-bold transition-all flex items-center ${matrixView === 'details' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-800'}`}><FileText className="w-3.5 h-3.5 mr-2" /> Fiches Détaillées</button>
            </div>

            {matrixView === 'table' && (
              <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden animate-in fade-in">
                <div className="p-5 border-b border-slate-100 bg-slate-50">
                  <h4 className="font-serif font-bold text-slate-800">Tableau 26. Cartographie des seuils visiteur/migrant par Pays</h4>
                </div>
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse text-sm">
                    <thead>
                      <tr className="bg-slate-100 border-b border-slate-200 text-slate-600">
                        <th className="py-4 px-5 font-bold text-[10px] uppercase tracking-widest w-1/4">Pays</th>
                        <th className="py-4 px-5 font-bold text-[10px] uppercase tracking-widest w-1/4">Seuil Légal Visiteur</th>
                        <th className="py-4 px-5 font-bold text-[10px] uppercase tracking-widest w-1/2">Notes sur l'Obligation de Résidence</th>
                      </tr>
                    </thead>
                    <tbody>
                      {legalMatrixData.map((regionObj, rIdx) => (
                        <React.Fragment key={rIdx}>
                          {/* Ligne d'en-tête pour la région remplaçant le rowSpan capricieux */}
                          <tr className="bg-slate-800 text-white">
                            <td colSpan={3} className="py-2.5 px-5 font-bold text-xs uppercase tracking-widest">
                              {regionObj.region}
                            </td>
                          </tr>
                          {regionObj.countries.map((country, cIdx) => (
                            <tr key={cIdx} className="hover:bg-slate-50 transition-colors border-b border-slate-100 last:border-0">
                              <td className="py-3 px-5 font-bold text-slate-800">{country.name}</td>
                              <td className="py-3 px-5">
                                <span className="inline-block bg-blue-50 text-blue-700 border border-blue-100 px-2.5 py-1 rounded text-xs font-bold whitespace-nowrap">
                                  {country.threshold}
                                </span>
                              </td>
                              <td className="py-3 px-5 text-xs text-slate-600 leading-relaxed">{country.tableNotes}</td>
                            </tr>
                          ))}
                        </React.Fragment>
                      ))}
            ...
            {/* Sources Académiques formatées */}
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm mt-8">
              <h4 className="text-sm font-bold text-slate-800 mb-4 flex items-center">
                <BookOpen className="w-4 h-4 mr-2 text-slate-400" />
                Liste des Instruments Juridiques Analysés (Sources)
              </h4>
              <div className="h-64 overflow-y-auto pr-4 custom-scrollbar text-[11px] text-slate-600 leading-relaxed space-y-5">
                
                <div>
                  <h5 className="font-bold text-slate-800 uppercase tracking-widest mb-2 border-b border-slate-100 pb-1">Afrique méditerranéenne</h5>
                  <ul className="space-y-1.5 list-disc list-inside pl-2">
                    <li><strong>Algérie :</strong> (2008). Loi n° 08-11 du 25 juin 2008 relative aux conditions d'entrée, de séjour et de circulation des étrangers.</li>
                    <li><strong>Égypte :</strong> (1960). Loi n° 89 de 1960 sur l'entrée et le séjour des étrangers (telle qu'amendée par la Loi n° 88/2005 et la Loi n° 173/2018).</li>
                    <li><strong>Libye :</strong> (1987). Loi n° 6 de 1987 organisant l'entrée, le séjour et la sortie des étrangers.</li>
                    <li><strong>Maroc :</strong> (2003). Loi n° 02-03 du 11 novembre 2003 relative à l'entrée et au séjour des étrangers au Royaume du Maroc, à l'émigration et à l'immigration irrégulières.</li>
                    <li><strong>Mauritanie :</strong> (1965). Loi n° 1965-046 fixant les dispositions applicables à l'admission et au séjour des étrangers (et décrets subséquents).</li>
                    <li><strong>Soudan :</strong> (1994). Passports and Immigration Act de 1994.</li>
                    <li><strong>Tunisie :</strong> (1968). Loi n° 68-7 du 8 mars 1968 relative à la condition des étrangers.</li>
                  </ul>
                </div>

                <div>
                  <h5 className="font-bold text-slate-800 uppercase tracking-widest mb-2 border-b border-slate-100 pb-1">Afrique de l'Ouest (Zone CEDEAO et Mauritanie exclue)</h5>
                  <ul className="space-y-1.5 list-disc list-inside pl-2">
                    <li><strong>Bénin :</strong> (2025). Loi n° 2025-15 relative aux conditions d'entrée, de séjour et d'établissement des étrangers.</li>
                    <li><strong>Burkina Faso :</strong> (2024). Loi de 2024 portant réglementation de l'entrée et du séjour des étrangers.</li>
                    <li><strong>Cap-Vert :</strong> (2014). Loi n° 66/VIII/2014.</li>
                    <li><strong>Côte d'Ivoire :</strong> (2004). Loi n° 2004-303 portant modification de la loi n° 2002-03.</li>
                    <li><strong>Gambie :</strong> (1965). Immigration Act (Cap. 16:02).</li>
                    <li><strong>Ghana :</strong> (2000). Immigration Act, 2000 (Act 573).</li>
                    <li><strong>Guinée :</strong> (1994). Loi L/94/019/CTRN portant sur les conditions d'entrée et de séjour des étrangers.</li>
                    <li><strong>Guinée-Bissau :</strong> (1992). Loi n° 2/92 sur la citoyenneté et Décret-Loi sur les étrangers.</li>
                    <li><strong>Liberia :</strong> (1973). Aliens and Nationality Law (Title 4 of the Liberian Code of Laws).</li>
                    <li><strong>Mali :</strong> (2004). Loi n° 04-058 relative aux conditions d'entrée, de séjour et d'établissement.</li>
                    <li><strong>Niger :</strong> (1981). Ordonnance n° 81-40 réglementant l'entrée et le séjour des étrangers.</li>
                    <li><strong>Nigeria :</strong> (2015). Immigration Act 2015.</li>
                    <li><strong>Sénégal :</strong> (1971). Loi n° 71-10 du 25 janvier 1971 relative aux conditions d'admission, de séjour et d'établissement des étrangers.</li>
                    <li><strong>Sierra Leone :</strong> (1965). Non-Citizens (Registration, Immigration and Expulsion) Act, 1965.</li>
                    <li><strong>Togo :</strong> (1987). Loi relative à la police des étrangers (actualisée en 2022).</li>
                  </ul>
                </div>

                <div>
                  <h5 className="font-bold text-slate-800 uppercase tracking-widest mb-2 border-b border-slate-100 pb-1">Afrique Centrale (CEMAC & CEEAC)</h5>
                  <ul className="space-y-1.5 list-disc list-inside pl-2">
                    <li><strong>Cameroun :</strong> (1997). Loi n° 97/012 du 10 janvier 1997 fixant les conditions d'entrée, de séjour et de sortie des étrangers.</li>
                    <li><strong>Gabon :</strong> (1986). Loi n° 5/86 fixant les conditions d'entrée et de séjour des étrangers.</li>
                    <li><strong>Guinée équatoriale :</strong> (2010). Loi organique n° 3/2010 réglementant l'entrée, le séjour et l'établissement.</li>
                    <li><strong>République centrafricaine :</strong> (2010). Code de l'immigration.</li>
                    <li><strong>République démocratique du Congo :</strong> (1983). Ordonnance-loi n° 83-033 relative à la police des étrangers.</li>
                    <li><strong>République du Congo :</strong> (1996). Loi n° 23-96 fixant les conditions d'entrée, de séjour et de sortie des étrangers.</li>
                    <li><strong>São Tomé-et-Príncipe :</strong> (2008). Loi n° 5/2008.</li>
                    <li><strong>Tchad :</strong> (1962). Ordonnance n° 27-62 relative à l'entrée et au séjour des étrangers.</li>
                  </ul>
                </div>

                <div>
                  <h5 className="font-bold text-slate-800 uppercase tracking-widest mb-2 border-b border-slate-100 pb-1">Afrique de l'Est</h5>
                  <ul className="space-y-1.5 list-disc list-inside pl-2">
                    <li><strong>Burundi :</strong> (2011). Loi n° 1/13 du 22 septembre 2011 portant révision de la législation sur l'immigration.</li>
                    <li><strong>Comores :</strong> (1988). Loi n° 88-025 relative aux conditions d'entrée et de séjour des étrangers.</li>
                    <li><strong>Djibouti :</strong> (2007). Loi n° 201/AN/07 portant conditions d'entrée et de séjour.</li>
                    <li><strong>Érythrée :</strong> (1992). Proclamation n° 24/1992 issued to regulate the issuing of travel documents, entry and exit visa.</li>
                    <li><strong>Éthiopie :</strong> (2003). Immigration Proclamation n° 354/2003.</li>
                    <li><strong>Kenya :</strong> (2011). Kenya Citizenship and Immigration Act, 2011.</li>
                    <li><strong>Madagascar :</strong> (1962). Loi n° 62-006 sur l'organisation et le contrôle de l'immigration.</li>
                    <li><strong>Maurice :</strong> (2022). Immigration Act 2022.</li>
                    <li><strong>Ouganda :</strong> (2009). Uganda Citizenship and Immigration Control Act (Cap. 66).</li>
                    <li><strong>Rwanda :</strong> (2018). Loi n° 57/2018 relative à l'immigration et à l'émigration.</li>
                    <li><strong>Seychelles :</strong> (1979). Immigration Decree 1979.</li>
                    <li><strong>Somalie :</strong> (1966). Immigration Law 1966.</li>
                    <li><strong>Soudan du Sud :</strong> (2011). Passports and Immigration Act, 2011.</li>
                    <li><strong>Tanzanie :</strong> (1995). Immigration Act 1995 (Cap. 54).</li>
                  </ul>
                </div>

                <div>
                  <h5 className="font-bold text-slate-800 uppercase tracking-widest mb-2 border-b border-slate-100 pb-1">Afrique Australe (SADC)</h5>
                  <ul className="space-y-1.5 list-disc list-inside pl-2">
                    <li><strong>Afrique du Sud :</strong> (2002). Immigration Act 13 of 2002.</li>
                    <li><strong>Angola :</strong> (2019). Loi n° 13/19 sur le régime juridique des étrangers en République d'Angola.</li>
                    <li><strong>Botswana :</strong> (2011). Immigration Act 2011.</li>
                    <li><strong>Eswatini :</strong> (1982). Immigration Act 1982.</li>
                    <li><strong>Lesotho :</strong> (1966). Aliens Control Act 1966.</li>
                    <li><strong>Malawi :</strong> (1968). Immigration Act (Cap. 15:03).</li>
                    <li><strong>Mozambique :</strong> (2022). Loi n° 23/2022 sur l'immigration.</li>
                    <li><strong>Namibie :</strong> (1993). Immigration Control Act 7 of 1993.</li>
                    <li><strong>Zambie :</strong> (2010). Immigration and Deportation Act 2010.</li>
                    <li><strong>Zimbabwe :</strong> (1979). Immigration Act (Chapter 4:02).</li>
                  </ul>
                </div>
